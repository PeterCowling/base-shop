        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              className="w-full border border-border-2 rounded-lg px-3 py-2 font-mono text-lg" // Use mono font for CC
          ...
          <div>
            ...
            <Input
              ...
              inputMode="numeric"
              autoComplete="cc-exp"
              className="w-full border border-border-2 rounded-lg px-3 py-2 font-mono text-lg"
              placeholder="MM/YY"
              value={expiryDate}
