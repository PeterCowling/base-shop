...
exports.default = ProductsIndexPage;
...
function ProductsIndexPage() {
    return __awaiter(this, void 0, void 0, function () {
      ...
      <ul className="space-y-2">
        {shops.map(function (shop) { return (<li key={shop}>
            <link_1.default href={"/cms/shop/".concat(shop, "/products")} className="text-primary underline">
              {shop}
            </link_1.default>
          </li>); })}
