/**
 * Generated CSS Parity Test — cochlearfit
 *
 ...
 *
 * cochlearfit is light-only. The committed file and generated output both
...
describe("cochlearfit — generateThemeCSS() parity with committed theme-tokens.generated.css", () => {
  // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------
  // .dark block — cochlearfit is light-only; .dark has no custom props
