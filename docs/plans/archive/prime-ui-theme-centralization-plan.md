...
- **Remaining surface assessment:**
  ...
  - app/ routes: **34 files, ~469 colors** → TASK-08 scope far exceeds M; needs split or lp-do-replan
...
- **Decision:** Continue building TASK-06, TASK-07 (≥80%). TASK-08 and TASK-09 need `/lp-do-replan` before building (scope split required). TASK-10 and TASK-11 remain eligible pending dependencies.
