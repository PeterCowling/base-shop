...
const receptionShadeColors = {
  ...
  "warmGreenShades-row1": "hsl(var(--color-warmGreenShades-row1))",
  "warmGreenShades-row2": "hsl(var(--color-warmGreenShades-row2))",
  "warmGreenShades-row3": "hsl(var(--color-warmGreenShades-row3))",
  "warmGreenShades-row4": "hsl(var(--color-warmGreenShades-row4))",
  "warmGreenShades-row5": "hsl(var(--color-warmGreenShades-row5))",
