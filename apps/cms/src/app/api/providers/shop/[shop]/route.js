...
function POST(req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var session, parsed, shop, dir, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, node_fs_1.promises.writeFile(node_path_1.default.join(dir, "providers.json"), JSON.stringify(parsed.data, null, 2), "utf8")];
                case 6:
                    _a.sent();
