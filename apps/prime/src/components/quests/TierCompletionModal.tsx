...
const TierCompletionModal: FC<TierCompletionModalProps> = memo(function TierCompletionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal content */}
      <div className="relative z-10 mx-4 w-full max-w-sm animate-bounce-in rounded-2xl bg-card p-6 shadow-2xl">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="mb-4 flex justify-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -right-1 flex h-8 w-8 items-center justify-center rounded-full bg-accent text-primary-foreground shadow-md">
        ...
        <button
          onClick={onClose}
          className="mt-4 w-full rounded-xl bg-accent px-4 py-3 font-semibold text-primary-foreground shadow-md transition-all hover:shadow-lg active:scale-[0.98]"
        >
