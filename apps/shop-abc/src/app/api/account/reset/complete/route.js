...
exports.ResetCompleteSchema = void 0;
exports.POST = POST;
...
exports.ResetCompleteSchema = zod_1.z
    .object({
...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, csrfToken, _a, _b, token, password, hashedToken, user, passwordHash;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, _shared_utils_1.parseJsonBody)(req, exports.ResetCompleteSchema, "1mb")];
                case 1:
                    parsed = _c.sent();
                    if (!parsed.success)
                ...
                case 3:
                    ...
                    _b = parsed.data, token = _b.token, password = _b.password;
                    hashedToken = crypto_1.default.createHash("sha256").update(token).digest("hex");
                    return [4 /*yield*/, (0, users_1.getUserByResetToken)(hashedToken)];
                case 4:
                    user = _c.sent();
                    if (!user) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Invalid or expired token" }, { status: 400 })];
                    }
                    return [4 /*yield*/, argon2_1.default.hash(password)];
                case 5:
                    passwordHash = _c.sent();
                    return [4 /*yield*/, (0, users_1.updatePassword)(user.id, passwordHash)];
                case 6:
                    _c.sent();
                    return [4 /*yield*/, (0, users_1.setResetToken)(user.id, null, null)];
                case 7:
                    _c.sent();
