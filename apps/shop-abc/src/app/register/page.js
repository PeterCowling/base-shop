...
function RegisterPage() {
    ...
    function handleSubmit(e) {
        return __awaiter(this, void 0, void 0, function () {
            var form, password, body, csrfToken, res, data;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$/.test(password)) {
                            setMsg("Password must be at least 8 characters and include uppercase, lowercase, and number");
                            return [2 /*return*/];
                        }
                        body = {
                            customerId: form.elements.namedItem("customerId").value,
    ...
    return (<form onSubmit={handleSubmit} className="space-y-2">
      ...
      <input name="password" type="password" placeholder="Password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).{8,}$" title="Password must be at least 8 characters and include uppercase, lowercase, and number" className="border p-1"/>
