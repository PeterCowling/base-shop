...
jest.mock(require.resolve("@ui/components/cms/page-builder/SelectionBreadcrumb"), () => stub("selection-breadcrumb"));
jest.mock(require.resolve("@ui/components/cms/page-builder/CommentsHelpLauncher"), () => stub("comments-help"));
jest.mock(require.resolve("@ui/components/cms/page-builder/PeerSelectionsOverlay"), () => stub("peer-overlay"));
jest.mock(require.resolve("@ui/components/cms/page-builder/SoftLockBanner"), () => stub("soft-lock"));
jest.mock(require.resolve("@ui/components/cms/page-builder/GridOverlay"), () => stub("grid-overlay"));
jest.mock(require.resolve("@ui/components/cms/page-builder/SnapLine"), () => ({ __esModule: true, default: ({ x }: any) => <div data-cy="snap-line" data-x={x} /> }));
jest.mock(require.resolve("@ui/components/cms/page-builder/RulersOverlay"), () => stub("rulers-overlay"));
jest.mock(require.resolve("@ui/components/cms/page-builder/MultiSelectOverlay"), () => stub("multi-overlay"));
...
jest.mock(require.resolve("@ui/components/cms/page-builder/hooks/useRulerProps"), () => ({ __esModule: true, default: () => ({ contentWidth: 1000, contentAlign: "center", contentAlignBase: "canvas", contentAlignSource: "auto" }) }));
...
import EditableCanvas from "@ui/components/cms/page-builder/EditableCanvas";
