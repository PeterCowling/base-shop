...
> Fact-find complete. Brief saved to `docs/plans/<feature-slug>/fact-find.md`. Status: `<Ready-for-planning | Needs-input>`. Primary execution skill: `<skill>`. Evidence gap review complete. Proceed to `/lp-do-plan` when blockers are resolved.
