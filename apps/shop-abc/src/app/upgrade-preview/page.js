...
exports.default = UpgradePreviewPage;
var react_1 = require("react");
var example_props_1 = require("./example-props");
var zod_1 = require("zod");
var upgrade_1 = require("@acme/types/upgrade");
var ComponentPreview_1 = require("@ui/src/components/ComponentPreview");
function UpgradePreviewPage() {
    ...
    (0, react_1.useEffect)(function () {
        function load() {
            return __awaiter(this, void 0, void 0, function () {
                var res, schema, data, _a, _b, pageLinks, err_1;
                var _this = this;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 5, , 6]);
                            return [4 /*yield*/, fetch("/api/upgrade-changes")];
                        case 1:
                            res = _c.sent();
                            schema = zod_1.z.object({
                                components: zod_1.z.array(upgrade_1.upgradeComponentSchema),
                        ...
                        case 2:
                            ...
                            if (!data.pages) return [3 /*break*/, 4];
                                        ...
                                        switch (_b.label) {
                                            ...
                                            case 2:
                                                ...
                                                if (typeof tokenData === "object" &&
                                                    ...
                                                    return [2 /*return*/, { id: id, url: "/preview/".concat(id, "?upgrade=").concat(tokenData.token) }];
                                                }
                                                return [2 /*return*/, null];
                                            case 3:
                                                _a = _b.sent();
                        ...
                        case 3:
                            pageLinks = (_c.sent()).filter(function (l) { return Boolean(l); });
                            setLinks(pageLinks);
                            _c.label = 4;
                        case 4: return [3 /*break*/, 6];
                        case 5:
                            err_1 = _c.sent();
                            console.error("Failed to load upgrade changes", err_1);
                            return [3 /*break*/, 6];
    ...
    return (<div className="space-y-8">
      <ul className="space-y-4">
        {changes.map(function (c) {
            ...
            <ComponentPreview_1.default component={c} componentProps={(_a = example_props_1.exampleProps[c.componentName]) !== null && _a !== void 0 ? _a : {}}/>
            {!c.oldChecksum && (<p className="text-sm text-gray-600">New component</p>)}
          </li>);
        })}
      </ul>
