...
# XA-J deployment (Cloudflare Pages, stealth mode)

XA is a Next.js app intended for Cloudflare Pages using `@cloudflare/next-on-pages`.

## Build and local preview
```
pnpm --filter @apps/xa-j exec next-on-pages
pnpm --filter @apps/xa-j exec wrangler pages dev .vercel/output/static --compatibility-flag=nodejs_compat --port 3015
```
...
- Service worker: `apps/xa-j/public/sw.js`
- Offline fallback page: `apps/xa-j/public/offline.html`
