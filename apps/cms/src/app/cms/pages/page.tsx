          ...
          <CardContent className="grid gap-4 p-6 sm:grid-cols-2 lg:grid-cols-3">
            {shops.map((shop) => (
              <Link
                ...
                className="group rounded-2xl border border-border/10 bg-background/60 px-4 py-5 text-sm font-medium text-foreground shadow-sm transition hover:border-border/40 hover:bg-muted/10"
              >
            ...
            {shops.length === 0 && (
              <div className="rounded-2xl border border-border/10 bg-background/60 px-4 py-5 text-sm text-muted-foreground">
                No shops found yet.
              </div>
            )}
          </CardContent>
