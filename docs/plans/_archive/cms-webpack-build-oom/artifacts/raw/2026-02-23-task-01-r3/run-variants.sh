...
artifact_dir="/Users/petercowling/base-shop/docs/plans/_archive/cms-webpack-build-oom/artifacts/raw/2026-02-23-task-01-r3"
cd "$repo" || exit 1
echo "cwd=$(pwd)" > "$artifact_dir/runner.trace"
...
run_variant() {
  ...
  echo "completed $name exit=$code" >> "$artifact_dir/runner.trace"
}
