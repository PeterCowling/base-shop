...
All workflow skills (`/lp-do-fact-find`, `/lp-do-analysis`, `/lp-do-plan`, `/lp-do-build`, `/lp-do-replan`, `/lp-do-sequence`) MUST follow this policy.
...
docs/plans/<slug>/
  ...
  analysis.md           # lp-do-analysis decision artifact
