...
export function useProducts() {
  ...
  const data: ProductsDataMap = useMemo<ProductsDataMap>(() => {
    return {
      ...
      /* ------------------------ 8 - MIXED DRINKS ---------------------- */
      8: [
        ["Limoncello", "bds", 5.5, "bg-warmGreenShades-row1"],
        ["Beefeater Gin", "bds", 8.0, "bg-warmGreenShades-row1"],
        ["Bombay Sapphire Gin", "bds", 10.0, "bg-warmGreenShades-row1"],
        ["Tanqueray Gin", "bds", 10.0, "bg-warmGreenShades-row1"],
        ["Hendricks Gin", "bds", 14.0, "bg-warmGreenShades-row1"],
        ["Skyy Vodka", "bds", 8.0, "bg-warmGreenShades-row2"],
        ["Absolut Vodka", "bds", 8.0, "bg-warmGreenShades-row2"],
        ["Smirnoff Vodka", "bds", 10.0, "bg-warmGreenShades-row2"],
        ["Grey Goose Vodka", "bds", 11.0, "bg-warmGreenShades-row2"],
        ["Johnnie Walker", "bds", 8.0, "bg-warmGreenShades-row3"],
        ["Jameson", "bds", 11.0, "bg-warmGreenShades-row3"],
        ["Jack Daniel", "bds", 11.0, "bg-warmGreenShades-row3"],
        ["Wild Turkey", "bds", 11.0, "bg-warmGreenShades-row3"],
        ["Chivas Regal", "bds", 14.0, "bg-warmGreenShades-row3"],
        ["Glenfidich", "bds", 18.0, "bg-warmGreenShades-row3"],
        ["Jose Cuervo", "bds", 8.0, "bg-warmGreenShades-row4"],
        ["Espolòn", "bds", 11.0, "bg-warmGreenShades-row4"],
        ["Pampero", "bds", 8.0, "bg-warmGreenShades-row4"],
        ["Bacardi Superior", "bds", 8.0, "bg-warmGreenShades-row4"],
        ["Captain Morgan", "bds", 11.0, "bg-warmGreenShades-row4"],
        ["Angostura Reserva", "bds", 12.5, "bg-warmGreenShades-row4"],
        /* mixers (zero‑price) */
        ["Mixer Tonic Water", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer Soda Water", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer OJ Mix", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer Coke", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer Coke Zero", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer Sprite", "bds", 0.0, "bg-warmGreenShades-row5"],
        ["Mixer Espresso", "bds", 0.0, "bg-warmGreenShades-row5"],
      ],
