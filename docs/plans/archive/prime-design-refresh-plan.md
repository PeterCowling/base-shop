...
- Related brief: `docs/plans/prime-design-refresh-lp-do-fact-find.md`
- Key findings:
...
- **Documentation impact:** None — design policy already documented in startup-loop-workflow.user.md during lp-do-fact-find
- **Notes / references:**
