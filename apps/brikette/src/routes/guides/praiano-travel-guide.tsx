// src/routes/guides/praiano-travel-guide.tsx
...
export const handle = { tags: ["praiano", "sunset", "beaches", "hidden-gems", "day-trip"] };

export const GUIDE_KEY = "praianoGuide" as const satisfies GuideKey;
export const GUIDE_SLUG = "praiano-travel-guide" as const;
...
if (!manifestEntry) {
  throw new Error("guide manifest entry missing for praianoGuide"); // i18n-exempt -- DEV-000 [ttl=2099-12-31]
}
