...
Related-Plan: docs/plans/remove-gallery-featulp-do-replan.md
---
...
**Recommended next step:** Proceed to `/lp-do-plan` to create atomic tasks with confidence assessments.
