...
var returnKeycardsToSafe: ReturnType<typeof vi.fn>;
var recordKeycardTransfer: ReturnType<typeof vi.fn>;
var addCashCount: ReturnType<typeof vi.fn>;
var recordFloatEntry: ReturnType<typeof vi.fn>;
...
vi.mock("../../../hooks/client/till/useTillShiftActions", () => ({
  useTillShiftActions: () => ({ returnKeycardsToSafe }),
}));

vi.mock("../../../hooks/useKeycardTransfer", () => ({
  useKeycardTransfer: () => recordKeycardTransfer,
}));

vi.mock("../../../hooks/useCashCounts", () => ({
...
var recordDeposit: ReturnType<typeof vi.fn>;
var recordWithdrawal: ReturnType<typeof vi.fn>;
var recordExchange: ReturnType<typeof vi.fn>;
var recordOpening: ReturnType<typeof vi.fn>;
var recordReconcile: ReturnType<typeof vi.fn>;
var recordReset: ReturnType<typeof vi.fn>;
var recordBankDeposit: ReturnType<typeof vi.fn>;
var recordBankWithdrawal: ReturnType<typeof vi.fn>;
var recordPettyWithdrawal: ReturnType<typeof vi.fn>;
...
vi.mock("../../till/ExchangeNotesForm", () => ({
  __esModule: true,
  ExchangeNotesForm: ({
    onConfirm,
    onCancel,
...
vi.mock("../../till/ReturnKeycardsModal", () => ({
  __esModule: true,
  default: ({
    onConfirm,
    onCancel,
...
describe("SafeManagement", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    updateCount = vi.fn();
    returnKeycardsToSafe = vi.fn(() => true);
    recordKeycardTransfer = vi.fn().mockResolvedValue(undefined);
    addCashCount = vi.fn();
    recordFloatEntry = vi.fn();
    recordBankDeposit = vi.fn();
    recordPettyWithdrawal = vi.fn();
    showToastMock = vi.fn();
    safeError = null;
