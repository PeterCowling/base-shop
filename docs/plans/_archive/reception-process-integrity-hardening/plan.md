...
## Fact-Find Reference
- Related brief: `docs/plans/_archive/reception-process-integrity-hardening/fact-find.md`
- Key findings used:
...
- Type: CHECKPOINT
- Execution-Skill: lp-do-build
- Affects: `docs/plans/_archive/reception-process-integrity-hardening/plan.md`
