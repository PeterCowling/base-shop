...
### Non-goals
- Implementing workflow changes in this fact-find.
...
- Brikette suite in recent runs: 104 suites / 699 tests (historic baseline from prior fact-find).
...
- Example commit behind run `21860231934` included prime + workflow edits:
  ...
  - `docs/plans/prime-ui-theme-centralization-fact-find.md`
...
- Recommended next step:
  - proceed to `/plan-feature` (or implement directly) for Brikette targeted test selection in deploy CI.
