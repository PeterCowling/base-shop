...
export const corePageTemplates: TemplateDescriptor[] = [
  {
    ...
    description:
      "Hero with CTA, value props, and a featured products grid for a marketing-focused home page.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Hero with story-led copy and curated tiles for campaign landings.", // i18n-exempt -- TPL-001: template metadata
    category: "Hero",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Seasonal hero, gift finder, and promo grid for holiday campaigns.", // i18n-exempt -- TPL-001: template metadata
    category: "Hero",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Grid-first product listing page suitable for category or shop routes.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Lookbook-style shop with hero panel and curated product clusters.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Service-forward layout with hero, packages grid, and booking CTA.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "PDP layout with media gallery, details, and related products grid.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Editorial PDP with immersive gallery, story, and related grid.", // i18n-exempt -- TPL-001: template metadata
    category: "Commerce",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Checkout-focused page shell with cart summary and payment section.", // i18n-exempt -- TPL-001: template metadata
    category: "System",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Company about page with hero, mission statement, and team section.", // i18n-exempt -- TPL-001: template metadata
    category: "Features",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Frequently asked questions page with expandable accordion items.", // i18n-exempt -- TPL-001: template metadata
    category: "Features",
    pageType: "marketing",
  ...
  },
  {
    ...
    description:
      "Shipping and returns policy page with clear sections for each policy.", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Yes, we ship to most countries worldwide. International shipping durations vary by destination.", // i18n-exempt -- TPL-001: placeholder content
          },
          {
  ...
  // ============================================================
  {
    ...
    description:
      "Standard terms of service page with sections for definitions, user obligations, payments, liability, and governing law.", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
  ...
  },
  {
    ...
    description:
      "GDPR/CCPA-compliant privacy policy with sections for data collection, usage, sharing, retention, and user rights.", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
  ...
  },
  {
    ...
    description:
      "Cookie policy explaining what cookies are used, their purposes, and how users can manage preferences (GDPR/CCPA compliant).", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
  ...
  },
  {
    ...
    description:
      "VAT and tax disclosure page explaining tax handling, invoicing, and jurisdiction-specific requirements (director-approved for Basic tier).", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
  ...
  },
  {
    ...
    description:
      "Accessibility statement describing WCAG compliance efforts, known issues, and how to report accessibility barriers.", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
  ...
  },
  {
    ...
    description:
      "Returns and refund policy page with eligibility criteria, process instructions, and refund timelines.", // i18n-exempt -- TPL-001: template metadata
    category: "Legal",
    pageType: "legal",
...
export const shippingReturnsPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.shipping-returns."));

// Legal & Compliance template exports (LAUNCH-27)
export const legalPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal."));

export const termsPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.terms."));

export const privacyPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.privacy."));

export const cookiePageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.cookie."));

export const vatPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.vat."));

export const accessibilityPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.accessibility."));

export const returnsPageTemplates: TemplateDescriptor[] =
  corePageTemplates.filter((tpl) => tpl.id.startsWith("core.page.legal.returns."));
