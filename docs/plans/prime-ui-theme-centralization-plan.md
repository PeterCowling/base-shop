...
| TASK-06 | IMPLEMENT | Migrate portal onboarding flow to DS primitives + enable DS rules | 82% | L | Pending | TASK-05 | TASK-10 |
| TASK-07 | IMPLEMENT | Migrate onboarding steps to DS primitives + enable DS rules | 86% | M | Pending | TASK-05 | TASK-10 |
| TASK-08 | IMPLEMENT | Migrate routes + check-in surfaces to DS primitives + enable DS rules | 78% | M→L | Needs re-plan | TASK-05 | TASK-10 |
| TASK-09 | IMPLEMENT | Migrate remaining component surfaces to DS primitives + enable DS rules | 75% | M→L | Needs re-plan | TASK-05 | TASK-10 |
| TASK-10 | IMPLEMENT | Remove blanket DS bypass from eslint.config.mjs + lint-wrapper.sh | 85% | M | Pending | TASK-06, TASK-07, TASK-08, TASK-09 | TASK-11 |
...
- **Remaining surface assessment:**
  ...
  - app/ routes: **34 files, ~469 colors** → TASK-08 scope far exceeds M; needs split or re-plan
...
- **Decision:** Continue building TASK-06, TASK-07 (≥80%). TASK-08 and TASK-09 need `/re-plan` before building (scope split required). TASK-10 and TASK-11 remain eligible pending dependencies.
