...
describe("theme service", function () {
    it("computes theme data", function () { return __awaiter(void 0, void 0, void 0, function () {
        var form, current, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    current = { themeId: "t2" };
                    return [4 /*yield*/, (0, theme_1.buildThemeData)("shop", form, current)];
                case 1:
                    result = _a.sent();
    ...
    it("removes theme token", function () {
        var current = {
            themeOverrides: { a: "1", b: "2" },
            themeDefaults: { a: "0" },
        };
        var result = (0, theme_1.removeThemeToken)(current, "a");
