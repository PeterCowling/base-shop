...
import { z } from "zod";
import { coreEnvBaseSchema, coreEnvSchema, loadCoreEnv } from "../core.js";
import { depositReleaseEnvRefinement } from "../depositRelease.js";
import { reverseLogisticsEnvRefinement } from "../reverseLogistics.js";
import { lateFeeEnvRefinement } from "../lateFee.js";

const NEXT_SECRET = "nextauth-secret-32-chars-long-string!";
const SESSION_SECRET = "session-secret-32-chars-long-string!";

const schema = coreEnvBaseSchema.superRefine((env, ctx) => {
...
// depositReleaseEnvRefinement tests moved to feature-specific suite
