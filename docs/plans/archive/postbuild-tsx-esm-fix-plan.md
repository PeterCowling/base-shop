...
- Related brief: `docs/plans/postbuild-tsx-esm-fix-lp-do-fact-find.md`
- Key findings:
...
- Is proven to work (validated in lp-do-fact-find)
...
- **Confidence:** 90%
  ...
  - Approach: 90% — Proven to work in lp-do-fact-find validation; main uncertainty is choosing which package path mappings must be made runtime-safe beyond `@acme/guides-core`
...
- **Planning validation:**
  ...
  - Unexpected findings: None - lp-do-fact-find already validated this approach works
...
- **Notes / references:**
  ...
  - Solution validated in lp-do-fact-find (line 199-204)
