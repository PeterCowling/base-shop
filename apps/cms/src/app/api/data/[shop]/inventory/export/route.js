...
function GET(req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var session, shop, items_1, format, csv, json, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    shop = (_a.sent()).shop;
                    return [4 /*yield*/, inventory_server_1.inventoryRepository.read(shop)];
                case 4:
                    items_1 = _a.sent();
                    format = new URL(req.url).searchParams.get("format");
                    if (!(format === "csv")) return [3 /*break*/, 6];
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            var chunks = [];
                            var stream = (0, fast_csv_1.format)({ headers: true });
                            stream
                                .on("error", reject)
                                .on("data", function (c) { return chunks.push(c.toString()); })
                                .on("end", function () { return resolve(chunks.join("")); });
                            items_1.map(inventory_1.flattenInventoryItem).forEach(function (i) { return stream.write(i); });
                            stream.end();
                        })];
                case 5:
                    csv = _a.sent();
                ...
                case 6:
                    json = items_1.map(function (i) { return (0, inventory_1.flattenInventoryItem)(i); });
                    return [2 /*return*/, server_1.NextResponse.json(json)];
                case 7:
                    err_1 = _a.sent();
