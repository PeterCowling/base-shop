    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    pages = _b.sent();
                    page = pages.find(function (p) { return p.slug === "product/".concat(slug) && p.status === "published"; });
...
function ProductDetailPage(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var isEnabled, product, components, latestPost, posts, first, _c, content, cfg;
        var _d;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    isEnabled = (0, headers_1.draftMode)().isEnabled;
                    return [4 /*yield*/, getProduct(params.slug, params.lang, isEnabled)];
                case 1:
                    product = _e.sent();
                    if (!product)
                        return [2 /*return*/, (0, navigation_1.notFound)()];
                    return [4 /*yield*/, loadComponents(params.slug)];
                case 2:
                    components = _e.sent();
                    return [4 /*yield*/, (0, analytics_1.trackPageView)(shop_json_1.default.id, "product/".concat(params.slug))];
                case 3:
                    _e.sent();
                    if (!(shop_json_1.default.luxuryFeatures.contentMerchandising && shop_json_1.default.luxuryFeatures.blog)) return [3 /*break*/, 7];
                    _e.label = 4;
                case 4:
                    _e.trys.push([4, 6, , 7]);
                ...
                case 6:
                    ...
                    return [3 /*break*/, 7];
                case 7:
                    content = components && components.length ? (<DynamicRenderer_1.default components={components} locale={params.lang} runtimeData={{ ProductDetailTemplate: { product: product } }}/>) : (<PdpClient_client_1.default product={product}/>);
