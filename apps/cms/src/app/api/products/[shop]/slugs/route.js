...
function POST(req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var shop, body, slugs, catalogue, wanted, existing, _i, catalogue_1, p, slug;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    body = _b.sent();
                    slugs = Array.isArray(body === null || body === void 0 ? void 0 : body.slugs) ? body.slugs : [];
                    if (slugs.length === 0) {
                ...
                case 3:
                    ...
                    existing = [];
                    for (_i = 0, catalogue_1 = catalogue; _i < catalogue_1.length; _i++) {
                        p = catalogue_1[_i];
                        slug = (_a = p.sku) !== null && _a !== void 0 ? _a : p.id;
                        if (wanted.has(slug))
                            existing.push(slug);
                    }
                    return [2 /*return*/, server_1.NextResponse.json(existing)];
            }
        });
    });
}
