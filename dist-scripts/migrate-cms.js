...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    base = (0, node_path_1.join)(__dirname, "..", "packages", "platform-core", "repositories");
                    return [4 /*yield*/, pushSchema("page", (0, node_path_1.join)(base, "pages", "schema.json"))];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, pushSchema("shop", (0, node_path_1.join)(base, "shops", "schema.json"))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
