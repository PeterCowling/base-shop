...
Owner: Pete
ID: BRIK-ENG-0015
Title: 'Plan: Theme Generation Workflow'
Business: BRIK
Tags:
  - plan-migration
  - theming
...
**Source:** Migrated from `theme-generation-workflow-plan.md`
...
[... see full plan in docs/plans/theme-generation-workflow-plan.md]
