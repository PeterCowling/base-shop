...
const STATIC_PROCESS_ENV = {
  ...
  NEXT_PUBLIC_OCTORATE_LIVE_AVAILABILITY:
    process.env.NEXT_PUBLIC_OCTORATE_LIVE_AVAILABILITY,
  NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_ENABLED:
    process.env.NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_ENABLED,
  NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_SCRIPT_SRC:
    process.env.NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_SCRIPT_SRC,
  NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_GLOBAL_KEY:
    process.env.NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_GLOBAL_KEY,
} as const;
...
export const OCTORATE_LIVE_AVAILABILITY =
  readEnv(["NEXT_PUBLIC_OCTORATE_LIVE_AVAILABILITY"]) === "1";
export const OCTORATE_CUSTOM_PAGE_ENABLED =
  readEnv(["NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_ENABLED"]) === "1";
export const OCTORATE_CUSTOM_PAGE_SCRIPT_SRC = readEnv([
  "NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_SCRIPT_SRC",
]);
export const OCTORATE_CUSTOM_PAGE_GLOBAL_KEY = readEnv([
  "NEXT_PUBLIC_OCTORATE_CUSTOM_PAGE_GLOBAL_KEY",
]);
