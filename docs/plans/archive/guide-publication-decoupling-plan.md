...
- Related brief: `docs/plans/guide-publication-decoupling-lp-do-fact-find.md`
- Key findings:
...
- **Implementation notes:**
  ...
  - TC-04 expected count: 119 published guides (lp-do-fact-find estimated 166 — corrected from actual data)
...
- **Documentation impact:** None
- **Notes / references:**
  - Draft route files listed in lp-do-fact-find `§ Entry Points → Brikette Draft Routes`
  - API route files listed in lp-do-fact-find `§ Entry Points → Brikette API Routes`
- **Status:** Complete (2026-02-08)
- **Implementation notes:**
...
- **Documentation impact:**
  - Update `docs/plans/guide-publication-decoupling-lp-do-fact-find.md` status to Complete
- **Notes / references:**
