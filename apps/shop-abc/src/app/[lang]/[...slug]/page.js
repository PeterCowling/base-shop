    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    pages = _b.sent();
                    page = pages.find(function (p) { return p.slug === slug && p.status === "published"; });
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, loadComponents(slug)];
                case 1:
                    components = _c.sent();
                    if (!components)
                        (0, navigation_1.notFound)();
                    return [4 /*yield*/, (0, analytics_1.trackPageView)(shop_json_1.default.id, slug)];
                case 2:
                    _c.sent();
                    return [2 /*return*/, <DynamicRenderer_1.default components={components} locale={params.lang}/>];
            }
        });
    });
}
