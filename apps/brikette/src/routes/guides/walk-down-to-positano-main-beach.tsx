// src/routes/guides/walk-down-to-positano-main-beach.tsx
...
export const GUIDE_KEY = "positanoMainBeachWalkDown" satisfies GuideKey;
export const GUIDE_SLUG = "walk-down-to-positano-main-beach" as const;
...
if (!manifestEntry) {
  throw new Error("guide manifest entry missing for positanoMainBeachWalkDown"); // i18n-exempt -- TECH-000 [ttl=2026-12-31] Developer-only safeguard
}
