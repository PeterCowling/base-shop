...
var LayoutClient_client_1 = require("./LayoutClient.client");
/** Server component – wraps every CMS page. */
function CmsLayout(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    session = _c.sent();
                    return [2 /*return*/, (<LayoutContext_1.LayoutProvider>
      <LayoutClient_client_1.default role={session === null || session === void 0 ? void 0 : session.user.role}>{children}</LayoutClient_client_1.default>
