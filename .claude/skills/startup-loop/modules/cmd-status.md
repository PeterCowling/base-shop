...
2. Re-evaluate gates and sync requirements for the current stage:
   - For stages DISCOVERY–S2: apply Gate A / Gate B / Gate C (defined in `cmd-start.md`).
   - For advance-blocking gates (GATE-DISCOVERY-00, GATE-BD-03, GATE-BD-08, GATE-S6B-STRAT-01, GATE-S6B-ACT-01): see `cmd-advance.md` for gate definitions.
