...
| Top-priority card with fact-find stage doc | `/lp-fact-find <card-id>` | Deep-dive investigation |
| Card without fact-find stage doc | `/lp-fact-find <card-id>` | Manual /lp-fact-find if desired |
