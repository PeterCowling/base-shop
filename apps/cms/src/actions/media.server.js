...
async function readMetadata(shop) {
    try {
...
export async function uploadMedia(shop, formData, requiredOrientation = "landscape") {
    await ensureAuthorized();
...
export async function deleteMedia(shop, filePath) {
