...
- `.github/workflows/ci.yml` deploys staging without a health check step.
- `scripts/src/setup-ci.ts` generates workflows without any post-deploy check.
...
- [ ] DEPLOY-02: Enforce health checks in `reusable-app.yml`
...
- [ ] DEPLOY-03: Wire health checks into root and app workflows
...
- [ ] DEPLOY-04: Update `scripts/src/setup-ci.ts` workflow generator
...
- [ ] DEPLOY-05: Enforcement and documentation
