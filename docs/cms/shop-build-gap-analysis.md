...
- Final solution ownership and status live in:
  ...
  - `docs/cms/shop-build-docs-help-do-plan.md` (docs/help/telemetry implementation for CMS-BUILD-11).
...
- **Canonical fields:** the wizard and related docs use the **Minimal first-product fields** defined in `docs/cms/shop-build-docs-help-do-plan.md#minimal-first-product-fields-canonical-list`:
...
- **Align telemetry with build-flow events**
  - When CMS-BUILD-05 adds build-flow telemetry, emit the `build_flow_step_*`, `build_flow_first_product_*`, `build_flow_help_requested`, and `build_flow_exit` events described in `docs/cms/shop-build-docs-help-do-plan.md` from:
...
This analysis feeds **CMS-BUILD-02** (gap → tasks), **CMS-BUILD-10** (first-product experience), and **CMS-BUILD-11** (docs + inline help + telemetry). The Journey Map (`docs/cms/shop-build-journey-map.md`) should be treated as the “what exists & how it connects”, this file as “what’s missing & why it hurts”, and `docs/cms/shop-build-docs-help-do-plan.md` as “how we’re fixing it”.
