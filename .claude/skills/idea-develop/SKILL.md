...
- Modifying existing cards (use `/idea-advance` for lane changes)
...
- Use `/wf-fact-find` skill for structured fact-finding

## Example Session (API)

```
User: /idea-develop BRIK-OPP-0001
...
4) POST /api/agent/stage-docs (wf-fact-find)
