...
> See `docs/plans/xa-deploy-readiness-lp-do-fact-find.md` for evidence. Old XA-READY-06/07/08 superseded by 06a–06d/07/08.
...
- 2026-02-08: Fact-find completed (`xa-deploy-readiness-lp-do-fact-find.md`) — compared Brikette production deploy with XA gaps
