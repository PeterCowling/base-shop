    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    entries = _a.sent();
                    return [2 /*return*/, entries.filter(function (e) { return e.isDirectory(); }).map(function (e) { return e.name; })];
                case 3:
                    err_1 = _a.sent();
                    console.error("Failed to list shops at ".concat(shopsDir, ":"), err_1);
                    throw err_1;
