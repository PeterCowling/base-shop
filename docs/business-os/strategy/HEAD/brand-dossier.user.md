...
- Brand strategy (BRAND-01): `docs/business-os/strategy/HEAD/brand-strategy.user.md`
- Naming shortlist r2 (name decision): `docs/business-os/strategy/HEAD/2026-02-21-naming-shortlist-r2.user.md`
