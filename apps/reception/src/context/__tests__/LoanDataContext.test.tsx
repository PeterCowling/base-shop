...
jest.mock("../../hooks/data/useFirebaseSubscription");
const mockedSubscription = jest.mocked(useFirebaseSubscription);

const saveLoanMock = jest.fn();
const removeLoanItemMock = jest.fn();
const removeLoanTransactionsForItemMock = jest.fn();
const updateLoanDepositTypeMock = jest.fn();
const convertKeycardDocToCashMock = jest.fn();
const removeOccupantIfEmptyMock = jest.fn();

jest.mock("../../hooks/mutations/useLoansMutations", () => ({
  default: () => ({
