...
export function PagesListItem({
  ...
  return (
    <>
      ...
      <button type="button" className="block w-full truncate px-2 py-1 min-h-11 min-w-11 text-start" onClick={() => onSelect(p.id)}>
      ...
      <div className="flex items-center justify-between gap-2 border-t px-2 py-1 text-xs">
        ...
        <div>
          <Button variant="outline" className="min-h-11 min-w-11 px-2" onClick={() => onSelect(p.id)}>
