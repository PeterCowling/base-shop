...
Updated: 2026-02-22
Owner: Pete
Output-Path: docs/business-os/strategy/HBAG/2026-02-22-product-from-photo.user.md
---

# PRODUCT-01 — Product from Photo (Caryina / HBAG)

## How to use this

1. Open a **multimodal AI session** (Claude, GPT-4o, or similar — must accept image uploads).
2. Upload your product photos in numbered sequence (Image 1, Image 2, …).
3. Paste the prompt below.
4. Save the full AI response as `docs/business-os/strategy/HBAG/2026-02-22-product-from-photo.user.md`.

---

## What photos to supply

Build a numbered sequence covering all physical variants you have in hand. Cover these in order:

### H1 — Bag Charm (lead variant)

| Image # | Shot | What to show |
|---------|------|--------------|
| 1 | Full body, clipped onto a full-size handbag strap | The natural hang; gold hardware visible; bag closed |
| 2 | Flat lay on white card or linen, slight angle | Whole bag from slightly above; editorial feel |
| 3 | Extreme close-up of clasp / gold hardware | Hardware quality; texture detail |
| 4 | Open bag — interior visible | Interior construction; any lining, pocket, or compartment |
| 5 | Close-up of stitching or edge finishing | Craft signal; the detail that justifies €80+ |

### H2 — AirPod Holder

| Image # | Shot | What to show |
|---------|------|--------------|
| 6 | Open bag flat with AirPods Pro case inside | Interior capacity — confirm fit |
| 7 | Bag clipped onto a strap or belt loop, closed | Carry format |
| 8 | Bag next to AirPods Pro case on white surface | Size reference |
| 9 | Close-up of attachment hardware | Hardware type and finish |

### Any additional colourways (H1 or H2)

Continue numbering. One full-body shot per colourway is minimum; add close-ups if the hardware or finish differs.

### H3 — Amalfi Location Variant (if samples exist)

| Image # | Shot | What to show |
|---------|------|--------------|
| Next | Bag with any printed Amalfi graphics visible | Confirm graphic placement and print quality |
| Next | Close-up of graphic area | Colour accuracy, registration, any special finish |
...
Save the full AI response as:

```
docs/business-os/strategy/HBAG/2026-02-22-product-from-photo.user.md
```

Add frontmatter at the top before saving:
...
Updated: 2026-02-22
Owner: Pete
Images-Used: <count of images supplied>
Variants-Identified: <V1, V2, ...>
---
```

Then update `docs/business-os/strategy/HBAG/index.user.md` to set PRODUCT-01 Status: Draft.
