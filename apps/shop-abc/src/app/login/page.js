...
var account_1 = require("@ui/components/account");
function LoginPage() {
    var _a = (0, react_1.useState)(""), msg = _a[0], setMsg = _a[1];
    var _b = (0, react_1.useState)(null), mfaUser = _b[0], setMfaUser = _b[1];
    var searchParams = (0, navigation_1.useSearchParams)();
    var callbackUrl = searchParams.get("callbackUrl");
    function handleSubmit(e) {
        return __awaiter(this, void 0, void 0, function () {
            var form, body, csrfToken, res, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = {
                            customerId: form.elements.namedItem("customerId")
                                .value,
                    ...
                    case 2:
                        ...
                        if (res.ok) {
                            ...
                            window.location.href = callbackUrl !== null && callbackUrl !== void 0 ? callbackUrl : "/account";
                            return [2 /*return*/];
                        }
    ...
    if (mfaUser) {
        return (<account_1.MfaChallenge customerId={mfaUser} onSuccess={function () {
                window.location.href = callbackUrl !== null && callbackUrl !== void 0 ? callbackUrl : "/account";
            }}/>);
    }
