...
| TASK-04 | INVESTIGATE | Add direct test coverage plan for `reportWebVitals.ts` to raise testability confidence | 76% ⚠️ | S | **Carried forward** → `docs/plans/brikette-cta-sales-funnel-ga4/fact-find.md` Track D seed #23 | - | - |
...
- ~~TASK-04~~: **Carried forward** to `docs/plans/brikette-cta-sales-funnel-ga4/fact-find.md` (Track D seed #23)
...
- **Status:** **Carried forward** → `docs/plans/brikette-cta-sales-funnel-ga4/fact-find.md` Track D seed #23
- **Type:** INVESTIGATE
- **Confidence:** 76% ⚠️ BELOW THRESHOLD
- **Reason for carry-forward:** This plan is being archived (TASK-01–03 complete). TASK-04 remains relevant and is absorbed into the broader CTA/GA4 conversion pipeline fact-find, which covers the same GA4 testing surface area.
- **Original acceptance:** Select preferred test seam and file location with one concrete example test case outline.
- **Notes / references:**
