    ...
    <Section as="div" padding="none" className="px-6 py-16 md:px-12">
      <Stack gap={3} className="mx-auto max-w-2xl">
        ...
        <div>
          <Link
            href="/"
            className="inline-flex items-center rounded-md border border-border-2 bg-panel px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-foreground"
          >
            Back home
          </Link>
        </div>
