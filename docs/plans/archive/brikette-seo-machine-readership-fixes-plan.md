...
- Duplicate content observed: `/de/rooms/` and `/de/zimmer/` both serve (lp-fact-find evidence)
- Trailing-slash decision: TASK-SEO-4 lp-replan (keep slashes)
...
- **When:** 2026-01-28 (lp-replanning investigation)
