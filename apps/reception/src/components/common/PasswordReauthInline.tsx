  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col items-center gap-3">
      ...
      <Button
        ...
        className="min-h-11 min-w-11 w-full rounded-lg bg-primary-600 px-4 py-2 font-medium text-primary-fg hover:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:opacity-50 dark:bg-darkAccentGreen dark:text-darkBg dark:hover:bg-darkAccentGreen/90"
      >
