...
| `build_flow_first_product_created` | When the minimal first product (as defined in `docs/cms/shop-build-docs-help-do-plan.md`) is created successfully. | `{ shopId, productId }` |
