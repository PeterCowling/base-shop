...
const removeItemFromOrder = vi.fn();
const updateItemInOrder = vi.fn();
const addItemToOrder = vi.fn();
...
vi.mock("../../../../hooks/mutations/useBleeperMutations", () => ({
  useBleeperMutations: () => ({ setBleeperAvailability: vi.fn() }),
}));

const getProductCategory2 = vi.fn((name: string) => {
