...
exports.default = StepCheckoutPage;
...
function StepCheckoutPage(_a) {
    var _this = this;
    var pageTemplates = _a.pageTemplates, checkoutLayout = _a.checkoutLayout, setCheckoutLayout = _a.setCheckoutLayout, checkoutComponents = _a.checkoutComponents, setCheckoutComponents = _a.setCheckoutComponents, checkoutPageId = _a.checkoutPageId, setCheckoutPageId = _a.setCheckoutPageId, shopId = _a.shopId, themeStyle = _a.themeStyle;
    var _b = (0, react_1.useState)({
        open: false,
        message: "",
    }), toast = _b[0], setToast = _b[1];
    var _c = (0, useStepCompletion_1.default)("checkout-page"), markComplete = _c[1];
    ...
    return (<div className="space-y-4">
      ...
      <shadcn_1.Select value={checkoutLayout} onValueChange={function (val) {
            var layout = val === "blank" ? "" : val;
            setCheckoutLayout(layout);
            var tpl = pageTemplates.find(function (t) { return t.name === layout; });
            if (tpl) {
                setCheckoutComponents(tpl.components.map(function (c) { return (__assign(__assign({}, c), { id: (0, ulid_1.ulid)() })); }));
            }
            else {
      ...
      <PageBuilder_1.default page={{
            id: checkoutPageId !== null && checkoutPageId !== void 0 ? checkoutPageId : "",
            slug: "",
            status: "draft",
        ...
        return [2 /*return*/];
    }); }); }} saving={isSaving} saveError={saveError} onChange={setCheckoutComponents} style={themeStyle}/>
