...
declare global {
  var __inventoryRateLimitStore: Map<string, RateLimitEntry> | undefined;
}
...
function getStore() {
  if (!globalThis.__inventoryRateLimitStore) {
    globalThis.__inventoryRateLimitStore = new Map<string, RateLimitEntry>();
  }
  return globalThis.__inventoryRateLimitStore;
}
