 ...
 */
export type BlockProps<TType extends BlockTypeId = BlockTypeId> = Extract<PageComponent, {
    type: TType;
}>;
/**
 ...
 * UI components.
 */
export interface BlockDescriptor<TType extends BlockTypeId = BlockTypeId, Features extends BlockFeatureFlags = BlockFeatureFlags> {
 ...
 */
export type BlockDescriptorMap<Features extends BlockFeatureFlags = BlockFeatureFlags> = Partial<Record<BlockTypeId, BlockDescriptor<BlockTypeId, Features>>>;
/**
 ...
 */
export declare function buildBlockRegistry<TEntry>(descriptors: readonly BlockDescriptor[], entries: readonly BlockRegistryEntryConfig<TEntry>[]): {
