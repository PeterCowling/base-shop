...
|---|---|---|---:|---:|---|---|
| TASK-01 | IMPLEMENT | Make related guides render by default | 92% | M | Pending | - |
| TASK-02 | IMPLEMENT | Add manifest validation for relatedGuides | 88% | M | Pending | TASK-01 |
...
### TASK-01: Make related guides render by default when configured
...
### TASK-02: Add manifest validation for relatedGuides correctness
...
- **Planning validation:**
  ...
  - Unexpected findings: Validation not enforced in CI (opportunity to add in TASK-06)
- **What would make this ≥90%:**
...
### TASK-03: Add coverage reporting for cross-references
...
### TASK-04: Add reciprocity warnings to coverage report
...
### TASK-05: Document Google Maps URL patterns and editorial guidance
...
- [ ] All tests passing (existing + new test cases for TASK-01, TASK-02)
