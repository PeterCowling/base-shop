...
exports.connectSanity = connectSanity;
exports.createSanityPost = createSanityPost;
...
function connectSanity(formData) {
    return __awaiter(this, void 0, void 0, function () {
        var config;
        return __generator(this, function (_a) {
            config = parseConfig(formData);
            return [2 /*return*/, (0, plugin_sanity_1.verifyCredentials)(config)];
        });
    });
}
function createSanityPost(formData) {
    return __awaiter(this, void 0, void 0, function () {
        var config, raw, post;
        var _a;
        return __generator(this, function (_b) {
            config = parseConfig(formData);
            raw = String((_a = formData.get("post")) !== null && _a !== void 0 ? _a : "{}");
            post = JSON.parse(raw);
            return [2 /*return*/, (0, plugin_sanity_1.publishPost)(config, post)];
        });
    });
}
