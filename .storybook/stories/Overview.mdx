...
<Title>Base Shop — Storybook Overview</Title>

<Subtitle>Docs-only homepage for quick orientation</Subtitle>
...
- Use `parameters: { cart: true }` to opt into the mocked `CartProvider`.
