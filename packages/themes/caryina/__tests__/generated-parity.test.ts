 ...
 *
 * This is the drift-detection gate: any hand-edit to the generated file,
 * or any change to tokens.ts / design-profile.ts that is not followed by
 * re-running the generator, will cause this test to fail.
 */
...
// ---------------------------------------------------------------------------
// Load the committed generated tokens file
// ---------------------------------------------------------------------------
...
describe("generateThemeCSS() output parity with theme-tokens.generated.css", () => {
  // ------------------------------------------------------------------
  // :root block coverage
  // ------------------------------------------------------------------
