...
- **Type:** IMPLEMENT
- **Affects:** `.claude/skills/lp-guide-audit/SKILL.md`, `.claude/skills/guide-translate/SKILL.md`
- **Depends on:** TASK-02
- **Confidence:** 85%
...
- **Test contract:**
  ...
  - **Test type:** documentation
  - **Run:** `rg -n \"git restore|git checkout --\" .claude/skills/lp-guide-audit/SKILL.md .claude/skills/guide-translate/SKILL.md`
