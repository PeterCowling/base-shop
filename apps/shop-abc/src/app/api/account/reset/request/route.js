...
exports.ResetRequestSchema = void 0;
exports.POST = POST;
...
exports.ResetRequestSchema = zod_1.z
    .object({
...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, csrfToken, _a, ip, rateLimited, user, token, hashedToken, expiresAt, resetUrl;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, _shared_utils_1.parseJsonBody)(req, exports.ResetRequestSchema, "1mb")];
                case 1:
                    parsed = _c.sent();
                    if (!parsed.success)
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, middleware_1.checkLoginRateLimit)(ip, parsed.data.email)];
                case 4:
                    rateLimited = _c.sent();
                    if (rateLimited)
                        return [2 /*return*/, rateLimited];
                    return [4 /*yield*/, (0, users_1.getUserByEmail)(parsed.data.email)];
                case 5:
                    user = _c.sent();
                    ...
                    return [4 /*yield*/, (0, users_1.setResetToken)(user.id, hashedToken, expiresAt)];
                case 6:
                    _c.sent();
                    resetUrl = "/account/reset?token=".concat(token);
                    return [4 /*yield*/, (0, email_1.sendEmail)(parsed.data.email, "Password reset", "Reset your password: ".concat(resetUrl))];
                case 7:
                    _c.sent();
                    _c.label = 8;
