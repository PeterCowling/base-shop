...
function generateMetadata(_a) {
    ...
    var product = (0, products_1.getProductBySlug)(params.slug);
    return {
...
function ProductDetailPage(_a) {
    ...
    var jsonLd = (0, seo_1.getStructuredData)({
        ...
        url: "/".concat(params.lang, "/product/").concat(params.slug),
        image: (_b = product.media[0]) === null || _b === void 0 ? void 0 : _b.url,
    ...
    return (<>
      ...
      {shop_json_1.default.showCleaningTransparency && <CleaningInfo_1.CleaningInfo />}
    </>);
}
