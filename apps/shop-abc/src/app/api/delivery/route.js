...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, settings, manager, provider, _a, region, date, window_1, carrier;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!((_b = shop_json_1.default.shippingProviders) === null || _b === void 0 ? void 0 : _b.includes("premier-shipping"))) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Premier shipping not available" }, { status: 400 })];
                    }
                ...
                case 2:
                    settings = _d.sent();
                    if (!((_c = settings.luxuryFeatures) === null || _c === void 0 ? void 0 : _c.premierDelivery) || !settings.premierDelivery) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Premier shipping not available" }, { status: 400 })];
                    }
                ...
                case 3:
                    ...
                    try {
                        _a = parsed.data, region = _a.region, date = _a.date, window_1 = _a.window, carrier = _a.carrier;
                        if (!settings.premierDelivery.regions.includes(region) ||
                            !settings.premierDelivery.windows.includes(window_1)) {
                            return [2 /*return*/, server_1.NextResponse.json({ error: "Invalid selection" }, { status: 400 })];
                        }
                        provider.schedulePickup(region, date, window_1, carrier);
                        return [2 /*return*/, server_1.NextResponse.json({ ok: true })];
                    }
                    catch (err) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: err.message }, { status: 400 })];
                    }
                    return [2 /*return*/];
            }
        });
