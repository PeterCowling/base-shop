...
export const handle = { tags: ["wineries", "tramonti", "amalfi", "cuisine", "day-trip"] };

export const GUIDE_KEY = "tramontiWineries" as const satisfies GuideKey;
export const GUIDE_SLUG = "tramonti-wineries-amalfi-coast" as const;
...
if (!manifestEntry) throw new Error("guide manifest entry missing for tramontiWineries"); // i18n-exempt -- TECH-000 [ttl=2026-12-31]
