...
Owner: Pete
ID: PLAT-ENG-0015
Title: SEO & Machine-Readable Implementation Plan
Business: PLAT
Tags:
  - plan-migration
  - platform
...
**Source:** Migrated from `seo-machine-readable-implementation.md`
...
[... see full plan in docs/plans/seo-machine-readable-implementation.md]
