...
const BookingModal2 = memo(function BookingModal2({
  ...
  return (
    <div className="layer-modal relative" data-layer="modal" data-testid={testId}>
      <div
        role="button"
        ...
        className="layer-modal-backdrop pointer-coarse:p-6 fixed inset-0
      ...
      >
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby={BOOKING_MODAL_2_TITLE_ID}
          className="w-full rounded-2xl bg-brand-bg p-6 text-start shadow-2xl drop-shadow-brand-primary-10
