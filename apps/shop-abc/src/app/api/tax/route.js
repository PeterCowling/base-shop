...
var tax_1 = require("@platform-core/tax");
...
var schema = zod_1.z
    .object({
    provider: zod_1.z.enum(["taxjar"]).default("taxjar"),
    amount: zod_1.z.number(),
    toCountry: zod_1.z.string(),
    toPostalCode: zod_1.z.string().optional(),
})
    .strict();
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, tax, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, tax_1.calculateTax)(parsed.data)];
                case 3:
                    tax = _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ tax: tax })];
                case 4:
                    err_1 = _a.sent();
