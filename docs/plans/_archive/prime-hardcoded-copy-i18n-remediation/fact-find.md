...
- Q1: For Prime guest UI, should "all supported locales" mean UI_LOCALES only (en/it) or full CONTENT_LOCALES set?
  ...
  - Decision owner: Pete
  - A: Full CONTENT_LOCALES scope, but ship with en/it completed first and progress from there. Phased rollout with English fallback for incomplete locales. (Decided 2026-02-27)
...
- Q2: Should Prime use shared package i18n source as canonical, or continue app-local namespace files under apps/prime/public/locales?
  ...
  - Decision owner: Pete
  - A: Shared canonical source with deterministic Prime namespace export step. (Decided 2026-02-27)
...
- Q3: Who owns translation content production for Prime, and what is the delivery timeline relative to code work?
  ...
  - Decision owner: Pete
  - A: Agent-assisted translation using existing `/guide-translate` workflow, Italian first then top-5 guest languages. Ship with en/it; other locales to follow. (Decided 2026-02-27)
