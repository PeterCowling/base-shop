...
var ce = /* @__PURE__ */ __name((e, t, a, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let i of ie(t)) !oe.call(e, i) && i !== a && H(e, i, { get: /* @__PURE__ */ __name(() => t[i], "get"), enumerable: !(s = ne(t, i)) || s.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? ae(re(e)) : {}, ce(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e)), "V");
var x;
var p = E(() => {
  x = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.9107027558362775.mjs.map
