...
- Key modules/files:
  ...
  - `.claude/skills/lp-guide-improve/SKILL.md` — orchestrator that invokes guide-translate; no changes needed
  - `.claude/skills/lp-guide-audit/SKILL.md` — references guide-translate as next step; no changes needed
