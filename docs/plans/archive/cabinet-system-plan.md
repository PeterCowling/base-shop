...
- Assumptions:
  ...
  - 7 open lp-do-fact-find questions proceed with documented defaults (all low-risk):
...
- Related brief: `docs/plans/cabinet-system-lp-do-fact-find.md`
- Key findings:
...
- Key modules/files:
  ...
  - `.claude/skills/lp-guide-improve/SKILL.md` (226 lines) — orchestration precedent
...
| CS-12 | CHECKPOINT | Horizon checkpoint — dry-run validation | 95% | S | Complete (2026-02-09) | CS-11 | CS-13, CS-14 |
| CS-13 | IMPLEMENT | Write persona: Technical code-review cabinet | 82% | L | Complete (2026-02-09) | CS-12 | CS-14 |
| CS-14 | IMPLEMENT | Validation run — full Cabinet sweep under `improve-data` stance | 82% | M | Complete (2026-02-10) | CS-12, CS-13 | - |

> Effort scale: S=1, M=2, L=3 (used for Overall-confidence weighting)

## Parallelism Guide

_Generated by `/lp-sequence`. Tasks within a wave can run in parallel via subagents._
...
| 7 | CS-14 | Wave 6: CS-13 | Full end-to-end validation run. Status: Complete (2026-02-10). |
...
- **Confidence:** 85%
  - Implementation: 88% — Stance concept well-defined in lp-do-fact-find. Two stances with clear descriptions.
...
- **Notes / references:**
  - Fact-find stance decisions: `cabinet-system-lp-do-fact-find.md` § "Questions > Resolved (User Decisions)" > stance entries
...
- **Confidence:** 80%
  ...
  - Approach: 82% — Minimum viable content defined in lp-do-fact-find: top 3 priorities, top 3 risks, 1+ metric per business; workload, skills, availability per person.
...
- **Notes / references:**
  ...
  - Fact-find minimum content: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Knowledge System" > maintenance loop proposal
...
- **Confidence:** 88%
  - Implementation: 90% — Well-defined grammar in lp-do-fact-find (Dossier Header delimiters, field specs, Decision Log format). Follows existing markdown template patterns in stage-doc-operations.md.
...
- **Acceptance:**
  ...
  - "Presentable Idea" minimum completeness checklist (5 criteria from lp-do-fact-find)
...
- **Notes / references:**
  - Fact-find Dossier Header grammar: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Data Model" > Dossier Header grammar rules
...
- **Blocks:** CS-11
- **Confidence:** 85%
  - Implementation: 88% — Lifecycle fully defined in lp-do-fact-find: store as Idea with `Tags: ["data-gap"]` + Dossier Header `Confidence-Tier: data-gap`.
...
- **Documentation impact:** None
- **Notes / references:**
  - Fact-find DGP lifecycle: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Confidence Gate Mechanism" > Data Gap Proposal lifecycle
...
- **Blocks:** CS-11
- **Confidence:** 82%
  - Implementation: 82% — Concept defined in lp-do-fact-find but no repo precedent for clustering. Agent must cluster semantically similar ideas within a single session.
...
- **Documentation impact:** None
- **Notes / references:**
  - Fact-find clustering proposal: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Dedup / Rival Clustering"
...
- **Notes / references:**
  ...
  - Fact-find expert lens table: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Expert Lenses" > cabinet generators table
...
- **Blocks:** CS-11
- **Confidence:** 85%
  - Implementation: 85% — Gatekeeper/prioritizer roles are well-defined in lp-do-fact-find. Munger/Buffett evaluate truth (stance-invariant). Drucker/Porter weight against business plans (stance as plan emphasis).
...
- **Documentation impact:** None
- **Notes / references:**
  - Fact-find filter/priority table: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Expert Lenses" > filter/prioritization stages table
  - Stance boundary: `cabinet-system-lp-do-fact-find.md` § "Questions > Resolved (User Decisions)" > stance boundary entries
...
- **Blocks:** CS-12
- **Confidence:** 80%
  - Implementation: 80% — Largest single deliverable (~800 lines). Integrates all persona files, implements 6-stage pipeline, stance parameter, API calls, confidence gate, clustering, and sweep report. Precedent: `lp-do-plan/SKILL.md` at 912 lines proves this scale works.
  - Approach: 82% — Hybrid architecture (orchestrator + library) proven by `guide-improve` pattern. Pipeline is well-defined in lp-do-fact-find.
...
- **Acceptance:**
  ...
  - Implements full pipeline (corrected ordering — lp-do-fact-find docs AFTER priority ranking):
    ...
    5. Card creation: Promoted ideas → raw ideas via API → create cards (NO lp-do-fact-find docs yet)
    6. Drucker/Porter priority: Re-rank cards against business plans
    7. Fact-find seeding: Top K cards (per Drucker/Porter ranking) get lp-do-fact-find stage docs. K defaults to 3.
  ...
  - Work-up is split: card creation (step 5) before Drucker/Porter (step 6), lp-do-fact-find seeding (step 7) after. This ensures lp-do-fact-find docs are only created for ideas that survive priority ranking.
...
- **Test contract:**
  - **Test cases (enumerated):**
    ...
    - TC-06: Work-up creates cards for promoted ideas WITHOUT lp-do-fact-find stage docs
...
- **Documentation impact:**
  - Update lp-do-fact-find brief status to reflect implementation
- **Notes / references:**
  - Current skill: `idea-generate/SKILL.md` (730 lines)
  - Orchestration precedent: `guide-improve/SKILL.md` (226 lines)
  - Largest existing skill: `lp-do-plan/SKILL.md` (912 lines)

---

### CS-12: Horizon checkpoint — dry-run validation

- **Status:** Complete (2026-02-09) — Structural validation passed (16.5/17 orchestrator, 7/7 personas, 9/9 support files). 5 minor formatting gaps, 0 critical issues.
- **Type:** CHECKPOINT
- **Depends on:** CS-11
- **Blocks:** CS-13, CS-14
- **Confidence:** 95%
- **Acceptance:**
  ...
  - Run `/lp-do-replan` on CS-13, CS-14 using evidence from dry-run
...
- **Horizon assumptions to validate:**
  ...
  - Pipeline ordering correct: cards created before Drucker/Porter, lp-do-fact-find docs seeded after
...
- **Status:** Complete (2026-02-09) — Commit `68929b8f30`
- **Type:** IMPLEMENT
...
- **Documentation impact:** None
- **Notes / references:**
  - Fact-find technical cabinet: `cabinet-system-lp-do-fact-find.md` § "Gap Detail: Expert Lenses" + § "Questions > Resolved" > technical cabinet entries
...
- **Confidence:** 82% (reassessed from 75% — CS-12 structural validation passed 16.5/17 orchestrator checks, 7/7 persona checks, 9/9 support file checks)
  - Implementation: 85% — All prior tasks structurally validated. Full end-to-end invocation depends on API availability.
...
- **Documentation impact:**
  - Update lp-do-fact-find brief status to "Implemented"
...
- [x] Clustering reduces duplicate ideas from multiple lenses
- [x] Munger/Buffett filter produces Kill/Hold/Promote verdicts with rationale
- [x] Drucker/Porter re-ranks against business plans (or maturity model fallback)
- [x] Technical cabinet integrated with trigger conditions
- [x] Business plans and people profiles bootstrapped with minimum viable content
- [x] Full validation sweep completes under `improve-data` stance
- [x] Pre-cabinet skill backup preserved
...
- 2026-02-09: 7 open lp-do-fact-find questions proceed with documented defaults (all low-risk, enumerated in Constraints & Assumptions)
- 2026-02-09: **Plan revision (feedback incorporation):**
  - Pipeline reordered: lp-do-fact-find stage docs now created AFTER Drucker/Porter ranking (top K only), not during work-up
...
- 2026-02-09: **Sequenced by `/lp-sequence`:** 14 tasks renumbered into topological order. Rename map: old CS-02→CS-01, CS-12→CS-02, CS-01→CS-03, CS-03→CS-04, CS-04→CS-05, CS-14→CS-06, CS-05→CS-07, CS-06→CS-08, CS-07→CS-09, CS-08→CS-10, CS-09→CS-11, CS-10→CS-12, CS-11→CS-13, CS-13→CS-14. All Blocks fields corrected to strict inverse of Depends on (removed transitive dependencies).
