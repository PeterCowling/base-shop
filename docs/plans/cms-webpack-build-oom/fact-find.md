...
Related-Plan: docs/plans/cms-webpack-build-oom/plan.md
...
| H3 | CMS build remains an active migration blocker and is explicitly governed as a hard blocker in the dedicated mitigation lane. | `docs/plans/turbopack-full-migration/plan.md`, `docs/plans/cms-webpack-build-oom/plan.md` | High |
...
- Dedicated mitigation plan exists (`docs/plans/cms-webpack-build-oom/plan.md`), but TASK-01 profiling artifact is still pending.
...
- Q: What gate policy should CMS build have for turbopack migration?
  ...
  - Decision: Option A hard-blocker policy selected on 2026-02-23 (input source: user decision), recorded in `docs/plans/cms-webpack-build-oom/plan.md` TASK-03.
...
- INVESTIGATE-01: Complete TASK-01 profiler artifact (`docs/plans/cms-webpack-build-oom/artifacts/profiling-baseline.md`) with command matrix and heap/profile pointers.
...
- Captured dedicated mitigation plan and recorded blocker-policy decision (**hard blocker**) in `docs/plans/cms-webpack-build-oom/plan.md` TASK-03 (2026-02-23).
...
- Recommended next step:
  - Execute `docs/plans/cms-webpack-build-oom/plan.md` via `/lp-do-build`, starting at TASK-01.
