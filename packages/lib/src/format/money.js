...
const currencyFractionDigitsCache = new Map();
function resolveCurrencyFractionDigits(currency) {
...
export function assertMinorInt(value) {
...
export function toMinor(inputMajor, currency) {
