...
var prepaymentDataMock: jest.Mock;
var addActivityMock: jest.Mock;
var logActivityMock: jest.Mock;
var addToAllTransactionsMock: jest.Mock;
var saveCCDetailsMock: jest.Mock;
...
jest.mock("../../../hooks/mutations/useCCDetailsMutations", () => {
  saveCCDetailsMock = jest.fn();
