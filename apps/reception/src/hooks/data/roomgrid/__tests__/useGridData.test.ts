...
vi.mock("../useGuestByRoomData");
vi.mock("../useGuestsDetailsData");
vi.mock("../useActivitiesData");
vi.mock("../../../client/checkin/useRoomConfigs");

const mockedBookings = vi.mocked(useBookingsData);
const mockedGuestByRoom = vi.mocked(useGuestByRoomData);
const mockedGuestsDetails = vi.mocked(useGuestsDetailsData);
const mockedActivities = vi.mocked(useActivitiesData);
const mockedRoomConfigs = vi.mocked(useRoomConfigs);
