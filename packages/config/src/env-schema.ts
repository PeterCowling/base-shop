 ...
 */
export function getDeployRequiredVars(): EnvVarDef[] {
 ...
 */
export function getBuildTimeVars(): EnvVarDef[] {
 ...
 */
export function getSecretVars(): EnvVarDef[] {
 ...
 */
export function getVarsByOwner(owner: EnvOwner): EnvVarDef[] {
 ...
 */
export function getVarDef(name: string): EnvVarDef | undefined {
