...
const saveRoomStatus = vi.fn().mockResolvedValue(undefined);

vi.mock("../../../data/useRoomsByDate", () => ({
  default: () => roomsResult,
}));
vi.mock("../../../data/useRoomStatus", () => ({
  default: () => statusResult,
}));
vi.mock("../../../data/useCheckins", () => ({
  useCheckins: () => checkinsResult,
}));
vi.mock("../../../data/useGuestByRoom", () => ({
  default: () => guestResult,
}));
vi.mock("../../../mutations/useRoomStatusMutations", () => ({
