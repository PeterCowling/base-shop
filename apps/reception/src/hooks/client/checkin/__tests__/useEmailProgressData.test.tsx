...
/* ------------------------------------------------------------------ */
/*  Import mocked modules to access the vi.fn instances                */
/* ------------------------------------------------------------------ */
...
const useActivitiesDataMock = vi.mocked(useActivitiesData);
const useActivitiesByCodeDataMock = vi.mocked(useActivitiesByCodeData);
...
beforeEach(() => {
  vi.useFakeTimers();
  vi.setSystemTime(new Date("2024-06-05T06:00:00Z"));
