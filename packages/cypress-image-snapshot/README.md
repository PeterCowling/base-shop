# @acme/cypress-image-snapshot

This is a workspace copy of [cypress-image-snapshot](https://github.com/palmerhq/cypress-image-snapshot) with modernized dependencies so it works with Cypress 14+ and Jest 29 while keeping the original API surface.

It binds [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot)'s image diffing logic to [Cypress.io](https://cypress.io) commands. **The goal is to catch visual regressions during integration tests.**
