...
var ParamsSchema = zod_1.z
    .object({ shop: zod_1.z.string(), id: zod_1.z.string() })
    .strict();
function GET(_req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, _a, _b, _c, shop, id, product;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = (_a = ParamsSchema).safeParse;
                    return [4 /*yield*/, context.params];
                case 1:
                    parsed = _b.apply(_a, [_d.sent()]);
                    if (!parsed.success)
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Invalid params" }, { status: 400 })];
                    _c = parsed.data, shop = _c.shop, id = _c.id;
