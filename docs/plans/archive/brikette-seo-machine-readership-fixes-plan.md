...
- Duplicate content observed: `/de/rooms/` and `/de/zimmer/` both serve (lp-do-fact-find evidence)
- Trailing-slash decision: TASK-SEO-4 lp-do-replan (keep slashes)
...
- **When:** 2026-01-28 (lp-do-replanning investigation)
