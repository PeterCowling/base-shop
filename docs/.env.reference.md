...
| `DB_MODE` | Global default for repository backends (`json` forces filesystem storage). Repo-specific `*_BACKEND` variables override this setting. |
...
| `INVENTORY_BACKEND` | `json` forces JSON/disk storage (default when `DATABASE_URL` is unset); when unset and `DATABASE_URL` is set, Prisma is used. |
| `PAGES_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `SHOP_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `PRODUCTS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `SETTINGS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `THEME_PRESETS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `ANALYTICS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `COUPONS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `SEO_AUDIT_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `PRICING_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `RETURN_LOGISTICS_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
| `RETURN_AUTH_BACKEND` | `json` forces JSON/disk storage; when unset and `DATABASE_URL` is set, Prisma is used. |
