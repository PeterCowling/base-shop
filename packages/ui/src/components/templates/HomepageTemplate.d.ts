 ...
 */
export declare function HomepageTemplate({ hero, recommendations, children, className, ...props }: HomepageTemplateProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=HomepageTemplate.d.ts.map