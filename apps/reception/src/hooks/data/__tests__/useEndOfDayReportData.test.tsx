...
const mockUseTillData = vi.fn();
const mockUseCashDiscrepanciesData = vi.fn();
const mockUseKeycardDiscrepanciesData = vi.fn();
const mockUseCCIrregularitiesData = vi.fn();
const mockUseSafeLogic = vi.fn();
const mockGetSafeBalanceAt = vi.fn();
const mockUseKeycardTransfersData = vi.fn();

vi.mock("../../../context/TillDataContext", () => ({
  useTillData: () => mockUseTillData(),
}));

vi.mock("../useCashDiscrepanciesData", () => ({
  useCashDiscrepanciesData: () => mockUseCashDiscrepanciesData(),
}));

vi.mock("../useKeycardDiscrepanciesData", () => ({
  useKeycardDiscrepanciesData: () => mockUseKeycardDiscrepanciesData(),
}));

vi.mock("../useKeycardTransfersData", () => ({
  useKeycardTransfersData: () => mockUseKeycardTransfersData(),
}));

vi.mock("../useCCIrregularitiesData", () => ({
  useCCIrregularitiesData: () => mockUseCCIrregularitiesData(),
}));

vi.mock("../../useSafeLogic", () => ({
