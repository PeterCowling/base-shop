...
function POST(req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var session, body, shop, patch, err_1;
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (Array.isArray(body.payment))
                        patch.paymentProviders = body.payment;
                    if (Array.isArray(body.shipping))
                        patch.shippingProviders = body.shipping;
                    return [4 /*yield*/, (0, shop_server_1.updateShopInRepo)(shop, patch)];
                case 5:
                    _a.sent();
