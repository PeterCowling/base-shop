...
Relates-to: docs/plans/design-system-lp-do-fact-find.md
Relates-to: docs/plans/react-audit-design-system-lp-do-fact-find.md
...
- **Affects:**
  ...
  - [readonly] `docs/plans/react-audit-design-system-lp-do-fact-find.md` (Finding 1)
- **Depends on:** -
- **Blocks:** -
- **Confidence:** 88%
...
- [ ] Brikette local layout primitives replaced with DS imports — DS-21a/21b (unblocked after lp-do-replan)
...
- 2026-02-07: Fact-find brief created — `docs/plans/design-system-lp-do-fact-find.md`
- 2026-02-07: Batch 1 build complete — DS-01 (`7aa38337ca`), DS-13 (`22a6c50ea9`), DS-14 (`9cae3f8849`), DS-18 (`d29a4f3cd4`)
- 2026-02-07: DS-21 blocked — API incompatibility discovered: brikette uses polymorphic `as` prop (38+ call sites), DS uses `asChild` pattern. Needs `/lp-do-replan`.
