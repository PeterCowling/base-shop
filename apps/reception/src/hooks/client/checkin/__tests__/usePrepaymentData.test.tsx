...
/* ------------------------------------------------------------------ */
/*  Register mocks first – Vitest hoists `vi.mock` calls               */
/*  Each factory returns a new `vi.fn()` without touching outer scope  */
/* ------------------------------------------------------------------ */
...
vi.mock("../../../data/useCCDetails", () => ({ default: vi.fn() }));
...
const useActivityByCodeMock = vi.mocked(useActivitiesByCodeData);
const useActivitiesMock = vi.mocked(useActivitiesData);
const useBookingsMock = vi.mocked(useBookingsData);
const useCCDetailsMock = vi.mocked(useCCDetails);
