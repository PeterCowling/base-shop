...
function usage() {
  return [
    "Usage:",
    "  node .claude/skills/user-testing-audit/scripts/run-full-js-off-sitemap-crawl.mjs --url <https://example.com/en> [options]",
    "",
    "Options:",
...
async function fetchWithTimeout(url, timeoutMs) {
  ...
  try {
    const response = await fetch(url, {
      ...
      redirect: "follow",
      headers: { "user-agent": "base-shop-user-testing-audit/1.0" },
    });
