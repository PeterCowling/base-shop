...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, to, subject, body, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, req.json().catch(function () { return ({}); })];
                case 1:
                    _a = (_c.sent()), to = _a.to, subject = _a.subject, body = _a.body;
                    if (!to || !subject || !body) {
                ...
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, email_1.sendCampaignEmail)({ to: to, subject: subject, html: body })];
                case 3:
                    _c.sent();
