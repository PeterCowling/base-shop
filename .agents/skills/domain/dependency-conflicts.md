...
2. **Check current state** — `pnpm why <package>`
3. **Determine scope** — Is it workspace-wide or package-specific?
4. **Apply fix** — Use appropriate scenario above
5. **Verify** — `pnpm install && pnpm build`
