...
- [ ] TASK-02: Fix container-widths-only-at-only files (10 files)
- [ ] TASK-03: Fix min-tap-size/enforce-layout-primitives single-rule files (5 files)
- [ ] TASK-04: Fix multi-rule files — pages cluster (8 files)
- [ ] TASK-05: Fix multi-rule files — components cluster (8 files, expanded)
