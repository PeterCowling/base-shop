// apps/shop-abc/__tests__/accountSessions.test.tsx
jest.mock("@auth", () => ({
  __esModule: true,
...
describe("revoke", () => {
  ...
  it("propagates errors", async () => {
    (revokeSession as jest.Mock).mockRejectedValue(new Error("fail"));
    await expect(revoke("s1")).rejects.toThrow("fail");
  });
});
