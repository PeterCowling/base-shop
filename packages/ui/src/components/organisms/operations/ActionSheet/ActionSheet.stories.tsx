...
import { Edit, Trash2, Copy, Share2, Archive } from 'lucide-react';
      ...
      <>
        ...
        >
          <div className="space-y-2">
            <button
              className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left text-gray-700 hover:bg-gray-50 dark:text-darkAccentGreen dark:hover:bg-darkBg"
              onClick={() => {
                alert('Edit clicked');
                setIsOpen(false);
              }}
            ...
            <button
              className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20"
              onClick={() => {
        ...
        >
          <div className="space-y-2">
            {items.map((item) => (
              <button
                key={item.id}
                className="flex w-full items-center justify-between rounded-lg px-4 py-3 text-left text-gray-700 hover:bg-gray-50 dark:text-darkAccentGreen dark:hover:bg-darkBg"
                onClick={() => {
