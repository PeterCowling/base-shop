...
export const paymentProviderTemplates: ProviderTemplate[] = [
  {
    ...
    description:
      "Standard Stripe integration with checkout sessions, webhooks, and card payments. Supports 135+ currencies and most payment methods.", // i18n-exempt -- TPL-001: template metadata
    category: "payment",
    capabilities: [
      "card-payments",
      "checkout-sessions",
  ...
  },
  {
    ...
    description:
      "Stripe Connect for marketplace/platform setups. Enables split payments, connected accounts, and platform fees.", // i18n-exempt -- TPL-001: template metadata
    category: "payment",
    capabilities: [
      "card-payments",
      "checkout-sessions",
  ...
  },
  {
    ...
    description:
      "PayPal integration with Express Checkout and Smart Payment Buttons. Supports PayPal balance, cards, and local payment methods.", // i18n-exempt -- TPL-001: template metadata
    category: "payment",
    capabilities: [
      "paypal-checkout",
      "card-payments",
...
export const shippingProviderTemplates: ProviderTemplate[] = [
  {
    ...
    description:
      "DHL Express shipping with real-time rates, label generation, and tracking. Supports international shipping to 220+ countries.", // i18n-exempt -- TPL-001: template metadata
    category: "shipping",
    capabilities: [
      "real-time-rates",
      "label-generation",
  ...
  },
  {
    ...
    description:
      "UPS shipping integration with rate quotes, label printing, and package tracking. Global coverage with multiple service levels.", // i18n-exempt -- TPL-001: template metadata
    category: "shipping",
    capabilities: [
      "real-time-rates",
      "label-generation",
  ...
  },
  {
    ...
    description:
      "Premier Shipping for luxury and high-value items. White-glove delivery with signature required and insurance included.", // i18n-exempt -- TPL-001: template metadata
    category: "shipping",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "Simple flat-rate shipping configuration. No external API required - rates are configured in shop settings.", // i18n-exempt -- TPL-001: template metadata
    category: "shipping",
    capabilities: [
      "flat-rate",
...
export const taxProviderTemplates: ProviderTemplate[] = [
  {
    ...
    description:
      "TaxJar for automated sales tax calculation, reporting, and filing. Covers US, EU VAT, Canada GST/PST, and Australia GST.", // i18n-exempt -- TPL-001: template metadata
    category: "tax",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "Manual tax rate configuration. Rates are defined in shop settings without external API integration.", // i18n-exempt -- TPL-001: template metadata
    category: "tax",
    capabilities: [
      "fixed-rate",
...
export const allProviderTemplates: ProviderTemplate[] = [
