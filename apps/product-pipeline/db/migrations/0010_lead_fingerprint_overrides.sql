-- Lead fingerprint overrides + duplicate candidate link
...
CREATE INDEX IF NOT EXISTS idx_leads_duplicate_of_candidate
  ON leads(duplicate_of_candidate_id);
CREATE INDEX IF NOT EXISTS idx_leads_fingerprint_market_id
  ON leads(fingerprint_market_id);
CREATE INDEX IF NOT EXISTS idx_leads_fingerprint_url
  ON leads(fingerprint_url);
CREATE INDEX IF NOT EXISTS idx_leads_fingerprint_title
  ON leads(fingerprint_title);
