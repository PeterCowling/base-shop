  ...
  return (
    ...
    >
      ...
      <span
        ...
        className={cn(
          // i18n-exempt -- DS-1234 [ttl=2025-11-30] — CSS utility class names
          "bg-fg text-bg pointer-events-none absolute top-full z-50 mt-2 whitespace-nowrap rounded px-2 py-1 text-xs shadow-md transition-opacity motion-reduce:transition-none",
