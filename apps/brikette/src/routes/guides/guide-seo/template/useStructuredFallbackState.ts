  ...
  const fallbackStructured = useMemo<StructuredFallback | null>(
    () =>
      ...
      buildStructuredFallback({
        ...
        hookI18n,
        appI18n: i18n,
        hasLocalizedContent: Boolean(hasLocalizedContent || hasStructuredLocalInitial),
        ...
        suppressEnglishWhenUnlocalized: Boolean(preferManualWhenUnlocalized),
        ...
        localGuidesTranslator: translations.tGuides as FallbackTranslator,
      }),
    [
      guideKey,
      lang,
