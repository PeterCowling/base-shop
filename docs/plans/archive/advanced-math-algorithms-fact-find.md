...
Archived: 2026-02-15
Archive-reason: Key math opportunities are now implemented in packages/lib/src/math; doc retained for provenance
Feature-Slug: advanced-math-algorithms
Business-Unit: PLAT
---

# Advanced Mathematics & Algorithms Upgrade — Fact-Find Brief
> **Archived (2026-02-15):** The major opportunities in this brief (experiment/forecasting/similarity) are now implemented in `packages/lib/src/math/*`.
> This document is retained for historical context; the gap list and some `[FACT]` statements are now stale.
...
|---|------------|---------------|--------|
| 1 | Learning Compiler (Opp L) | `docs/plans/archive/learning-compiler-plan.md` | Planned |
