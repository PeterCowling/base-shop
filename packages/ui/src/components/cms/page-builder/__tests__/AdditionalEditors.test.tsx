...
describe("additional editors", () => {
  const cases = [
    ...
    },
    {
      name: "FooterEditor",
      Comp: FooterEditor,
      component: { type: "Footer", logo: "", links: [] },
      getNode: () => screen.getByPlaceholderText("logo"),
      fire: (node: HTMLElement) => fireEvent.change(node, { target: { value: "logo.png" } }),
      expected: { logo: "logo.png" },
    },
    {
      name: "HeaderEditor",
      Comp: HeaderEditor,
      component: { type: "Header", logo: "", nav: [] },
      getNode: () => screen.getByPlaceholderText("logo"),
      fire: (node: HTMLElement) => fireEvent.change(node, { target: { value: "logo.png" } }),
      expected: { logo: "logo.png" },
    },
