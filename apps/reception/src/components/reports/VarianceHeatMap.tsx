...
export default function VarianceHeatMap() {
  ...
  if (error) {
    return (
      <PageShell title="Variance Heatmap">
        <p className="text-error-main">Failed to load data.</p>
      </PageShell>
    );
  }
          ...
          <div className="rounded-lg border border-border bg-surface p-4 shadow-lg">
            ...
            <div className="mt-4 flex flex-wrap items-end gap-4">
              ...
              <Button
                ...
                className="h-9 rounded-lg bg-primary-main px-4 text-sm text-primary-fg hover:bg-primary-dark disabled:opacity-50"
              >
                Save thresholds
              </Button>
            </div>
