...
const messages = {
  en: {
    ...
    syncStatusCatalogLabel: "Catalog",
    syncStatusSiteLabel: "Site",
    syncStatusCatalogPublished: "Published",
    syncStatusCatalogNone: "–",
    syncStatusSiteDeployTriggered: "Rebuild triggered — awaiting verification",
    syncStatusSiteDeployCooldown: "Rebuild pending (cooldown)",
    syncStatusSiteDeployFailed: "Rebuild trigger failed",
    syncStatusSiteRebuildRequired: "Rebuild required",
    syncStatusSiteNone: "–",
  ...
  zh: {
    ...
    syncStatusCatalogLabel: "目录",
    syncStatusSiteLabel: "网站",
    syncStatusCatalogPublished: "已发布",
    syncStatusCatalogNone: "–",
    syncStatusSiteDeployTriggered: "正在触发重建，待验证",
    syncStatusSiteDeployCooldown: "等待重建（冷却中）",
    syncStatusSiteDeployFailed: "触发重建失败",
    syncStatusSiteRebuildRequired: "需要重建",
    syncStatusSiteNone: "–",
