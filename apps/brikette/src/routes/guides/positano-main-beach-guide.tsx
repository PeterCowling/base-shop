// src/routes/guides/positano-main-beach-guide.tsx
...
export const GUIDE_KEY = "positanoMainBeach" as const satisfies GuideKey;
export const GUIDE_SLUG = "positano-main-beach-guide" as const;
...
if (!manifestEntry) {
  throw new Error("guide manifest entry missing for positanoMainBeach"); // i18n-exempt -- TECH-000 [ttl=2026-12-31] Non-UI invariant
}
