 ...
 */
export declare function ReviewsList({ reviews, minRating, query, filterable, onMinRatingChange, onQueryChange, className, ...props }: ReviewsListProps): import("react/jsx-runtime").JSX.Element;
