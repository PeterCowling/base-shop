...
var pricing_server_1 = require("@platform-core/repositories/pricing.server");
function POST(req, _context) {
    return __awaiter(this, void 0, void 0, function () {
        var session, body, parsed, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    body = _a.sent();
                    parsed = types_1.pricingSchema.safeParse(body);
                    if (!parsed.success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: parsed.error.flatten().formErrors.join(", ") }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, pricing_server_1.writePricing)(parsed.data)];
                case 4:
                    _a.sent();
