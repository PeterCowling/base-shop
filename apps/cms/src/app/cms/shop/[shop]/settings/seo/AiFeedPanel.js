...
function AiFeedPanel(_a) {
            ...
            switch (_c.label) {
                ...
                case 1:
                    events = (_c.sent())
                        ...
                        .reverse();
                    if (events.length === 0) {
                        return [2 /*return*/, (<div className="space-y-2 text-sm">
    ...
    <ul className="space-y-1">
      {events.map(function (e, idx) { return (<li key={idx}>
          {(0, date_utils_1.formatTimestamp)(e.timestamp)} – {e.status}
        </li>); })}
    </ul>
  </div>)];
            }
