---
name: lp-do-discovery-01-problem-framing
description: Problem framing for new startups (DISCOVERY-01). Produces a falsifiable problem statement artifact before entering DISCOVERY intake. Upstream of lp-do-discovery-02-solution-space-scan.
---

# lp-do-discovery-01-problem-framing — Problem Framing (DISCOVERY-01)
...
```
/lp-do-discovery-01-problem-framing --business <BIZ>
```
...
List the 8 highest-priority questions that cannot be answered from existing evidence and require first-party validation (interviews, cohort data, conversion tests). Prioritise questions about problem reality and severity — not product or channel design (those go to DISCOVERY-02).

If the operator provided a longer question set, preserve only the top 8 here and note that the rest are in the DISCOVERY-02 prompt.
...
|---|---|---|---|
| Research appendix (if created) | `s0a-research-appendix.user.md` | DISCOVERY-01 | — |
| Solution-space prompt | `<YYYY-MM-DD>-solution-space-prompt.md` | DISCOVERY-02 | — |
| Solution-space results | `<YYYY-MM-DD>-solution-space-results.user.md` | DISCOVERY-02 | — |
...
| Distribution plan | `distribution-plan.user.md` | DISCOVERY-05 | — |
| Measurement plan | `measurement-plan.user.md` | DISCOVERY-06 | — |
| Operator evidence | `s0e-operator-evidence.user.md` | DISCOVERY-07 | — |
...
Downstream: docs/business-os/strategy/<BIZ>/<YYYY-MM-DD>-solution-space-prompt.md
---
...
*Full question set (product, channel, requirements) is in the DISCOVERY-02 prompt.*
...
| Artifact | Path | Stage | Status |
|---|---|---|---|
| Research appendix | `s0a-research-appendix.user.md` | DISCOVERY-01 | (pending / date) |
| Solution-space prompt | `<YYYY-MM-DD>-solution-space-prompt.md` | DISCOVERY-02 | (pending / date) |
| Solution-space results | `<YYYY-MM-DD>-solution-space-results.user.md` | DISCOVERY-02 | (pending / date) |
| Option selection decision | `s0c-option-select.user.md` | DISCOVERY-03 | (pending / date) |
| Naming research prompt | `naming-research-prompt.md` | DISCOVERY-04 | (pending / date) |
| Distribution plan | `distribution-plan.user.md` | DISCOVERY-05 | (pending / date) |
| Measurement plan | `measurement-plan.user.md` | DISCOVERY-06 | (pending / date) |
| Operator evidence | `s0e-operator-evidence.user.md` | DISCOVERY-07 | (pending / date) |
...
**Downstream consumer:** `/lp-do-discovery-02-solution-space-scan --business <BIZ>` reads this file as its primary input.
...
**Downstream:** `/lp-do-discovery-02-solution-space-scan --business <BIZ>` reads `docs/business-os/strategy/<BIZ>/problem-statement.user.md` as its primary input. Do not proceed to solution space if a STOP advisory is present without operator acknowledgement.
