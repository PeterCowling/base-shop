...
var PricingForm_1 = require("./PricingForm");
exports.revalidate = 0;
function PricingPage(_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, pricing_server_1.readPricing)()];
                case 3:
                    initial = _c.sent();
                    return [2 /*return*/, (<div>
      <h2 className="mb-4 text-xl font-semibold">Rental Pricing</h2>
      <PricingForm_1.default shop={shop} initial={initial}/>
    </div>)];
            }
        });
    });
