    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    shop = _a.sent();
                    updated = (0, shops_1.setSanityConfig)(shop, undefined);
                    return [4 /*yield*/, (0, shop_server_1.updateShopInRepo)(shopId, updated)];
                case 4:
                    _a.sent();
                    return [2 /*return*/, { message: "Sanity disconnected" }];
                case 5:
                    err_1 = _a.sent();
                    console.error("Failed to disconnect Sanity", err_1);
                    return [2 /*return*/, { error: "Failed to disconnect Sanity" }];
