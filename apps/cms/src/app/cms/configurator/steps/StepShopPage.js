...
function StepShopPage(_a) {
    var _this = this;
    var pageTemplates = _a.pageTemplates, shopLayout = _a.shopLayout, setShopLayout = _a.setShopLayout, shopComponents = _a.shopComponents, setShopComponents = _a.setShopComponents, shopPageId = _a.shopPageId, setShopPageId = _a.setShopPageId, shopId = _a.shopId, themeStyle = _a.themeStyle, prevStepId = _a.prevStepId, nextStepId = _a.nextStepId;
    var _b = (0, react_1.useState)({
        open: false,
        message: "",
    }), toast = _b[0], setToast = _b[1];
    var _c = (0, useStepCompletion_1.default)("shop-page"), markComplete = _c[1];
    ...
    return (<div className="space-y-4">
      ...
      <shadcn_1.Select value={shopLayout} onValueChange={function (val) {
      ...
      <PageBuilder_1.default page={{
            id: shopPageId !== null && shopPageId !== void 0 ? shopPageId : "",
            slug: "",
            status: "draft",
        ...
        }); }} saving={isSaving} publishing={isPublishing} saveError={saveError} publishError={publishError} onChange={setShopComponents} style={themeStyle}/>
