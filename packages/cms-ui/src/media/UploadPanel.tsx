...
import { Spinner } from "@acme/design-system/atoms";
import { Cover , Inline } from "@acme/design-system/primitives";
        ...
        {pendingFile && (isVideo || isValid !== null) && (
          <div className="space-y-2">
            ...
            {!isVideo && (
              ...
              >
                {isValid
                  ? t("cms.image.orientation.ok", { actual: actual ?? "" })
                  : t("cms.image.orientation.bad", { actual: actual ?? "", required: REQUIRED_ORIENTATION })}
              </p>
            )}
            {(isVideo || isValid) && (
