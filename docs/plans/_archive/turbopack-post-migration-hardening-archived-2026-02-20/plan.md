...
## Fact-Find Reference
- Related brief: `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/fact-find.md`
- Key findings used:
...
- **Planning validation (required for M/L):**
  ...
  - Validation artifacts:
    - Fact-find evidence at `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/fact-find.md`
  - Unexpected findings:
...
- **Type:** INVESTIGATE
- **Deliverable:** analysis artifact at `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/artifacts/guides-core-export-investigation.md`
- **Execution-Skill:** lp-do-build
- **Execution-Track:** code
- **Effort:** S
- **Status:** Complete (2026-02-19)
...
- **Build completion evidence (2026-02-19):**
  - Created artifact: `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/artifacts/guides-core-export-investigation.md`.
...
- **Planning validation (required for M/L):**
  ...
  - Validation artifacts:
    - `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/fact-find.md`
  - Unexpected findings:
...
- **Type:** INVESTIGATE
- **Deliverable:** analysis artifact at `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/artifacts/ci-turbopack-smoke-probe.md`
- **Execution-Skill:** lp-do-build
- **Execution-Track:** code
- **Effort:** S
- **Status:** Complete (2026-02-19)
...
- **Build completion evidence (2026-02-19):**
  - Created artifact: `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/artifacts/ci-turbopack-smoke-probe.md`.
...
- **Planning validation (required for M/L):**
  ...
  - Validation artifacts:
    - `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/fact-find.md`
    - `docs/plans/archive/turbopack-post-migration-hardening-archived-2026-02-20/artifacts/ci-turbopack-smoke-probe.md` (from TASK-05)
  - Unexpected findings:
