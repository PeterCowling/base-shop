...
async function main(): Promise<void> {
  ...
  const fileLines = [
    ...
    "/book-dorm-bed/  /en/book-dorm-bed/  301",
    "/book-private-accomodations  /en/book-private-accomodations  301",
    "/book-private-accomodations/  /en/book-private-accomodations/  301",
    "",
    ...
    "",
    "# Legacy /en/book -> /en/book-dorm-bed (booking route renamed)",
    "/en/book  /en/book-dorm-bed  301",
    "/en/book/  /en/book-dorm-bed/  301",
    "",
    "# Legacy /en/dorms root -> /en/book-dorm-bed (booking funnel update)",
    "/en/dorms  /en/book-dorm-bed  301",
    "/en/dorms/  /en/book-dorm-bed/  301",
    "",
    "# Legacy private booking routes -> /en/book-private-accomodations",
    "/en/private-rooms/book  /en/book-private-accomodations  301",
    "/en/private-rooms/book/  /en/book-private-accomodations/  301",
    "/en/apartment/book  /en/book-private-accomodations  301",
    "/en/apartment/book/  /en/book-private-accomodations/  301",
    "",
