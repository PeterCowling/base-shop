...
jest.mock("../../../hooks/data/useActivitiesByCodeData", () => ({ __esModule: true, default: jest.fn() }));
jest.mock("../../../hooks/data/usePreorder", () => ({ __esModule: true, default: jest.fn() }));
jest.mock("../../../hooks/data/useBookingsData", () => ({ __esModule: true, default: jest.fn() }));
jest.mock("../../../hooks/data/useGuestDetails", () => ({ __esModule: true, default: jest.fn() }));
jest.mock("../../../hooks/data/useGuestsByBooking", () => ({ __esModule: true, default: jest.fn() }));
jest.mock("../ModalPreorderDetails", () => ({
  __esModule: true,
  default: ({ guestName }: { guestName: string }) => (
    <div data-cy="modal">Modal for {guestName}</div>
  ),
}));

// Get stable mock references
const useActivitiesByCodeDataMock = jest.requireMock("../../../hooks/data/useActivitiesByCodeData").default as jest.Mock;
const usePreorderMock = jest.requireMock("../../../hooks/data/usePreorder").default as jest.Mock;
const useBookingsDataMock = jest.requireMock("../../../hooks/data/useBookingsData").default as jest.Mock;
const useGuestDetailsMock = jest.requireMock("../../../hooks/data/useGuestDetails").default as jest.Mock;
const useGuestsByBookingMock = jest.requireMock("../../../hooks/data/useGuestsByBooking").default as jest.Mock;
