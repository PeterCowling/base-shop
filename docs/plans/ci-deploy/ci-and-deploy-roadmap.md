...
- [ ] **P2.2 Draft path filters (conceptual)**
  ...
  - [ ] Add a lightweight contributor note (e.g. in `docs/development.md` or app-level `AGENTS.md`) reminding devs: *“When adding a new shared package dependency to an app, update its workflow path filters so CI fan-out stays correct.”*
