...
- For `launch-surface=pre-website` (WEBSITE-01): once `site-v1-builder-prompt.user.md` is `Status: Active`, auto-handover to DO using mandatory sequence `lp-do-fact-find -> lp-do-analysis -> lp-do-plan -> lp-do-build`.
...
- `required_output_path_1`: `docs/plans/<biz>-website-v1-first-build/fact-find.md` (`Status: Ready-for-analysis`)
- `next_action_2`: `Run /lp-do-analysis <biz>-website-v1-first-build`
- `required_output_path_2`: `docs/plans/<biz>-website-v1-first-build/analysis.md` (`Status: Ready-for-planning`)
- `next_action_3`: `Run /lp-do-plan <biz>-website-v1-first-build`
- `required_output_path_3`: `docs/plans/<biz>-website-v1-first-build/plan.md` (`Status: Active`)
- `next_action_4`: `Run /lp-do-build <biz>-website-v1-first-build` (only after `plan.md` is `Status: Active`)
