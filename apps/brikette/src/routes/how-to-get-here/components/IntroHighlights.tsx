              ...
              components={{
                Link: (
                  <a
                    ...
                    className="inline-flex min-h-11 min-w-11 items-center px-1 font-semibold text-brand-primary underline underline-offset-4 transition-colors hover:no-underline dark:text-brand-secondary"
                  />
                ),
              }}
            />
