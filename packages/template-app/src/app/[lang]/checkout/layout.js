...
function LocaleLayout(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var langParam, raw, lang, messages, seo;
        var children = _b.children, params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, params];
                case 1:
                    langParam = (_c.sent()).lang;
                    raw = (langParam !== null && langParam !== void 0 ? langParam : [])[0];
                    lang = (0, locales_1.resolveLocale)(raw);
                    return [4 /*yield*/, Promise.resolve("".concat(
                        /* webpackInclude: /(en|de|it)\.json$/ */
                        "@i18n/".concat(lang, ".json"))).then(function (s) { return require(s); })];
                case 2:
                    messages = (_c.sent()).default;
                    return [4 /*yield*/, (0, seo_1.getSeo)(lang)];
                case 3:
                    seo = _c.sent();
                    return [2 /*return*/, (<Translations_1.default messages={messages}>
      <next_seo_1.DefaultSeo {...seo} additionalLinkTags={seo.additionalLinkTags}/>
      <Header_1.default lang={lang}/>
