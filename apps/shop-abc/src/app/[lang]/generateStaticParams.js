...
function generateStaticParams() {
    return __awaiter(this, void 0, void 0, function () {
        var pages, published, params, _i, LOCALES_1, lang, _a, published_1, page;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, index_server_1.getPages)(shop_json_1.default.id)];
                case 1:
                    pages = _b.sent();
                    published = pages.filter(function (p) { return p.status === "published"; });
                    params = [];
                    for (_i = 0, LOCALES_1 = i18n_1.LOCALES; _i < LOCALES_1.length; _i++) {
                        lang = LOCALES_1[_i];
                        params.push({ lang: lang });
                        for (_a = 0, published_1 = published; _a < published_1.length; _a++) {
                            page = published_1[_a];
                            if (page.slug === "home")
                                continue;
                            params.push({ lang: lang, slug: page.slug.split("/") });
                        }
                    }
