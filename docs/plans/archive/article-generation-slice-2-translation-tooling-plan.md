...
Fact-find foundation from `docs/plans/article-generation-pipeline-lp-do-fact-find.md` is usable for code-track planning:
...
| Condition | Action |
|---|---|
| Any IMPLEMENT task <80% | Run `/lp-do-replan` for that task before build |
...
- 2026-02-09: S2-03 and S2-05 kept below gate intentionally pending deeper contract work (`/lp-do-replan` required).
...
- 2026-02-09 (lp-do-replan): S2-03 promoted from 79% to 83% based on executable seam verification and is now build-eligible.
- 2026-02-09 (lp-do-replan): S2-05 remains blocked at 74%; added S2-09 (policy decision) and S2-10 (parity spike) as formal precursors.
