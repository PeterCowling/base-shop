...
function DealsBanner({ beds, time, lang }: DealsBannerProps): JSX.Element {
  ...
  return (
    <div
      ref={setBannerRef}
      className="sticky top-0 flex w-full items-center justify-center bg-brand-primary px-6 py-3 text-brand-on-primary shadow-md motion-safe:animate-slide-down"
    >
