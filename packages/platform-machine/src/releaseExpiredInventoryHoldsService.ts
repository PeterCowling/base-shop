...
// Auto-start in non-test environments unless explicitly disabled
// Set DISABLE_EXPIRED_INVENTORY_HOLD_RELEASE_SERVICE=true to disable
if (
  process.env.NODE_ENV !== "test" &&
  process.env.DISABLE_EXPIRED_INVENTORY_HOLD_RELEASE_SERVICE !== "true"
) {
