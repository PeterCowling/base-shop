// src/routes/guides/capri-on-a-budget.tsx
...
export const GUIDE_KEY: GuideKey = "capriOnABudget";
export const GUIDE_SLUG = "capri-on-a-budget" as const;

export const handle = { tags: ["budgeting", "capri", "day-trip"] };
...
if (!manifestEntry) {
  throw new Error("guide manifest entry missing for capriOnABudget"); // i18n-exempt -- TECH-000 [ttl=2026-12-31] Developer-only safeguard surfaced in build logs
}
