...
- Preserve workflow continuity from idea generation to lp-do-fact-find, plan, and build.
...
- Constraints:
  ...
  - Deterministic lane transitions remain in `/lp-do-plan` and `/lp-do-build`.
...
## Fact-Find Reference
- Related brief: `docs/plans/business-os-ideas-surface-and-automation-lp-do-fact-find.md`
- Key findings:
  ...
  - Highest weak points: partial sweep drift, fairness starvation for older P1/P2 without lp-do-fact-find docs, discovery-index fragility.
...
- Key modules/files:
  ...
  - `.claude/skills/idea-generate/SKILL.md` — Stage 6/7 behavior and determinism contract.
- Patterns to follow:
...
| TASK-06 | CHECKPOINT | End-to-end workflow verification (idea-generate -> lp-do-fact-find -> lp-do-plan -> lp-do-build) | 92% | S | Completed (2026-02-09) | TASK-01, TASK-02, TASK-04A | - |
...
- **Acceptance:**
  ...
  - If overridden to Option B, create explicit follow-up lp-do-replan note for impacted tasks.
...
- **Execution-Skill:** lp-do-build
- **Affects:** `.claude/skills/idea-generate/SKILL.md`, `.claude/skills/lp-do-fact-find/SKILL.md`, `.claude/skills/lp-do-plan/SKILL.md`, `.claude/skills/lp-do-build/SKILL.md`, `docs/business-os/agent-workflows.md`
- **Depends on:** -
- **Blocks:** TASK-06
- **Confidence:** 92%
...
- **Validation contract:**
  ...
  - VC-02: lp-do-fact-find/plan/build contracts each include stale-index failure behavior.
...
- **Validation executed (2026-02-09):**
  - `rg -n "discovery-index stale|reconciliation checklist|fail-closed|retry" .claude/skills/idea-generate/SKILL.md .claude/skills/lp-do-fact-find/SKILL.md .claude/skills/lp-do-plan/SKILL.md .claude/skills/lp-do-build/SKILL.md docs/business-os/agent-workflows.md`
...
- **Documentation impact:** `docs/business-os/agent-workflows.md`, `.claude/skills/idea-generate/SKILL.md`
...
- **Canonical contract (lp-do-replan outcome):**
...
- **Type:** INVESTIGATE
- **Status:** Completed (2026-02-09)
- **Deliverable:** Decision memo + implementation-ready contract for optional Stage 7b (`max 1 existing P1/P2 card without lp-do-fact-find doc`).
- **Execution-Skill:** lp-do-build
...
- **Validation executed (2026-02-09):**
  ...
  - Skill contract updated with explicit optional Stage 7b activation/selector/reporting rules in `.claude/skills/idea-generate/SKILL.md`.
- **Notes / references:**
  - `docs/plans/business-os-stage-7b-backfill-decision-memo.md`

### TASK-06: End-to-end workflow verification (idea-generate -> lp-do-fact-find -> lp-do-plan -> lp-do-build)
- **Type:** CHECKPOINT
- **Status:** Completed (2026-02-09)
...
- **Validation contract:**
  ...
  - VC-02: run representative `/lp-do-fact-find`, `/lp-do-plan`, `/lp-do-build` flow and confirm lane transitions remain deterministic.
...
- Metrics:
  - Primary bucket count (P1-P3), secondary bucket count (P4-P5), ideas without lp-do-fact-find docs.
- Alerts/Dashboards:
...
- Outcomes:
  ...
  - TASK-03 was 78% at lp-do-replan time and is now completed via explicit Option A confirmation (2026-02-09).
  - TASK-04B and TASK-05 were below threshold at this pass and were explicitly deferred pending follow-up evidence.
- Next buildable sequence at lp-do-replan time:
...
- 2026-02-09: lp-do-replan pass after TASK-01/TASK-02 marked TASK-04A and TASK-06 as next build-ready path.
- 2026-02-09: completed TASK-04A with fail-closed reconciliation + stale-index contract alignment across idea-generate/lp-do-fact-find/lp-do-plan/lp-do-build and workflow docs.
...
- 2026-02-09: lp-do-replanned TASK-04B with canonical `/api/automation/status` contract and header signal mapping; confidence raised to 82%.
