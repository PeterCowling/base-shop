...
|----------|------|--------|---------------|
| Brand Dossier | `docs/business-os/strategy/PET/2026-02-17-brand-identity-dossier.user.md` | Draft | 2026-02-17 |
...
grep "Brand Dossier" docs/business-os/strategy/PET/index.user.md | grep -E "Draft|Active"
```
