...
### Non-goals
- Implementing workflow changes in this lp-do-fact-find.
...
- Brikette suite in recent runs: 104 suites / 699 tests (historic baseline from prior lp-do-fact-find).
...
- Example commit behind run `21860231934` included prime + workflow edits:
  ...
  - `docs/plans/prime-ui-theme-centralization-lp-do-fact-find.md`
...
- Recommended next step:
  - proceed to `/lp-do-plan` (or implement directly) for Brikette targeted test selection in deploy CI.
