...
function SignupPage() {
    function createAccount(formData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, accounts_server_1.requestAccount)(formData)];
                    case 1:
                        _a.sent();
    ...
    return (<form action={createAccount} className="mx-auto mt-40 w-72 space-y-4">
      <h2 className="text-lg font-semibold">Create account</h2>
      <shadcn_1.Input name="name" type="text" placeholder="Name" required className="w-full"/>
