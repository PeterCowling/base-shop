      ...
      <Grid cols={6} gap={4} className="justify-center">
        {Array.from({ length: PIN_LENGTH }, (_, i) => (
          <Input
            ...
            className={`aspect-square w-14 rounded-lg text-center text-3xl font-semibold text-foreground caret-transparent transition-transform duration-150 focus:scale-110 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-white ${pin[i] !== " " ? PIN_BG_CLASSES[i] : EMPTY_BG_CLASS}`}
            value={pin[i] === " " ? "" : pin[i]}
