/*
 * Test-typecheck compatibility shim for `@jest/globals`.
 *
 * CI test typecheck runs TypeScript without executing Jest. Some package test
 * configs import from `@jest/globals`; this declaration maps those imports to
 * the ambient Jest globals already provided by `@types/jest`.
 */
