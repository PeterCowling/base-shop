...
|---|---|---|---|---|---|
| `docs/plans/_archive/cms-webpack-build-oom/plan.md` | Plan gate contract | Option A selected: CMS remains hard blocker in dependent migration gates; mitigation sequencing preserves hard-gate posture. | High | `cms-webpack-build-oom` plan operator (Infra/PLAT; inferred) | `docs/plans/_archive/cms-webpack-build-oom/plan.md:66`, `docs/plans/_archive/cms-webpack-build-oom/plan.md:73`, `docs/plans/_archive/cms-webpack-build-oom/plan.md:191` |
