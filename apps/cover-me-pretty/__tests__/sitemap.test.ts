...
describe("sitemap generation", () => {
  ...
  it("builds URLs with hreflang alternates and blog entries", async () => {
    ...
    process.env.NEXT_PUBLIC_SHOP_ID = "cover-me-pretty";
    ...
    expect(getShopSettingsMock).toHaveBeenCalledWith("cover-me-pretty");
    expect(readRepoMock).toHaveBeenCalledWith("cover-me-pretty");
