...
| CS-14 | IMPLEMENT | Validation run — full Cabinet sweep under `improve-data` stance | 82% | M | Pending | CS-12, CS-13 | - |
...
- **Blocks:** -
- **Status:** Pending (unblocked — CS-12 checkpoint passed with structural validation)
