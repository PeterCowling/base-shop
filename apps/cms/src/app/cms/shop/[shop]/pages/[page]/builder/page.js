...
exports.default = PageBuilderRoute;
var pages_server_1 = require("@cms/actions/pages.server");
var index_server_1 = require("@platform-core/repositories/pages/index.server");
var dynamic_1 = require("next/dynamic");
var navigation_1 = require("next/navigation");
var PageBuilder = (0, dynamic_1.default)(function () { return Promise.resolve().then(function () { return require("@ui/components/cms/PageBuilder"); }); });
void PageBuilder;
exports.revalidate = 0;
function PageBuilderRoute(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        function save(formData) {
            return __awaiter(this, void 0, void 0, function () {
                "use server";
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, pages_server_1.updatePage)(shop, formData)];
                });
            });
        }
        ...
        var _c, shop, slug, pages, current;
        var params = _b.params;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, params];
                case 1:
                    _c = _d.sent(), shop = _c.shop, slug = _c.page;
                    return [4 /*yield*/, (0, index_server_1.getPages)(shop)];
                case 2:
                    pages = _d.sent();
                    current = pages.find(function (p) { return p.slug === slug; });
                    if (!current)
      ...
      <PageBuilder page={current} history={current.history} onSave={save} onPublish={publish}/>
    </>)];
            }
        });
    });
