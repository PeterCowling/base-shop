...
- **Deliverable-Type:** one of:
  ...
  - `whatsapp-message`
  - `multi-deliverable`
- **Startup-Deliverable-Alias:** optional clarity label for startup and website-upgrade flows (does not replace `Deliverable-Type`):
  - `none` (default)
...
- Execution profile:
  ...
  - For `website-upgrade-backlog`: existing site baseline path, platform baseline path, and reference-site list
...
- For website-upgrade requests:
  - platform baseline pointer (`docs/business-os/platform-capability/latest.user.md`)
  - business brief pointer (`docs/business-os/site-upgrades/<BIZ>/latest.user.md`)
  - reference-site decomposition evidence
  - if baseline/brief is missing or stale: stop and present the corresponding Deep Research prompt template path
...
- include a filled copy-paste prompt block (not only the template path)
...
### Website Upgrade Inputs (required when `Startup-Deliverable-Alias: website-upgrade-backlog`)
- Existing site baseline:
  - ...
- Platform capability baseline:
  - `docs/business-os/platform-capability/latest.user.md` -> <active baseline path>
- Business upgrade brief:
  - `docs/business-os/site-upgrades/<BIZ>/latest.user.md` -> <active brief path>
- Reference sites:
  - ...
- Prompt templates used (if baseline/brief was refreshed in this run):
  - `docs/business-os/platform-capability/_templates/deep-research-platform-capability-baseline-prompt.md`
  - `docs/business-os/site-upgrades/_templates/deep-research-business-upgrade-prompt.md`
...
| Pattern | Source reference | User value | Commercial impact | Platform fit | Effort | Risk | Classification (Adopt/Adapt/Defer/Reject) | Rationale |
|---|---|---:|---:|---:|---:|---:|---|---|
| ... | ... | ... | ... | ... | ... | ... | ... | ... |
...
- [ ] For `website-upgrade-backlog` tracks: Website Upgrade Inputs section is complete with active baseline/brief pointers.
- [ ] For `website-upgrade-backlog` tracks: Best-Of Synthesis Matrix and prioritized backlog candidates are complete with acceptance criteria and evidence refs.
- [ ] For `website-upgrade-backlog` tracks with missing/stale prerequisites: filled Deep Research prompt blocks and exact save paths are included.
