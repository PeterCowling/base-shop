...
function buildPublicConfig() {
  return {
    brandName:
      ...
      "XA-J", // i18n-exempt -- XA-0001 [ttl=2026-12-31] placeholder brand name
    domain:
...
const catalogConfig = {
  category: "jewelry" as XaCategory,
  categories: ["jewelry"] as XaCategory[],
  departments: ["women", "men"] as XaDepartment[],
  defaultDepartment: "women" as XaDepartment,
  label: "Jewelry",
  labelPlural: "jewelry",
  productNoun: "jewelry piece",
  productNounPlural: "jewelry pieces",
  productDescriptor: "fine jewelry",
  packagingItems: "jewelry boxes or pouches",
} as const;
...
export const siteConfig = {
  ...
  heroHeadline: "The finest fine jewelry. By invitation.",
  heroSubheadline: "Exclusive access to curated jewelry from established designers.",
} as const;
