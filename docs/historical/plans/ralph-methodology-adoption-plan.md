...
| `.claude/prompts/lp-do-plan.md` | Planning mode prompt |
| `.claude/prompts/lp-do-build.md` | Building mode prompt |
...
- [x] Create `.claude/prompts/lp-do-plan.md` — planning mode prompt (use spec in § "Detailed Specifications")
- [x] Create `.claude/prompts/lp-do-build.md` — building mode prompt (use spec in § "Detailed Specifications")
...
Planning prompt: `.claude/prompts/lp-do-plan.md`
Building prompt: `.claude/prompts/lp-do-build.md`
...
### .claude/prompts/lp-do-plan.md (NEW)
...
### .claude/prompts/lp-do-build.md (NEW)
...
- Use `.claude/prompts/lp-do-plan.md` and `lp-do-build.md` patterns
...
3. `.claude/prompts/lp-do-plan.md`
4. `.claude/prompts/lp-do-build.md`
...
1. Test lp-do-plan.md prompt with Claude
2. Test lp-do-build.md prompt with Claude
