...
export function getOtherSections(t: (key: string) => string): BuiltInSection[] {
  return [
  {
    ...
    build: () => ({ id: ulid(), type: "CampaignHeroSection", mediaType: "image", imageSrc: "/placeholder-hero.jpg", usps: [
  ...
  },
  {
    ...
    build: () => ({ id: ulid(), type: "PromoTilesSection", density: "editorial", tiles: [
      { imageSrc: "/a.jpg", caption: "New In", /* i18n-exempt seed */ ctaLabel: "Shop", /* i18n-exempt seed */ ctaHref: "/collections/new" },
      { imageSrc: "/b.jpg", caption: "Best Sellers", /* i18n-exempt seed */ ctaLabel: "Explore", /* i18n-exempt seed */ ctaHref: "/collections/best" },
      { imageSrc: "/c.jpg", caption: "Clearance", /* i18n-exempt seed */ ctaLabel: "Save now", /* i18n-exempt seed */ ctaHref: "/collections/sale" },
    ] } satisfies PageComponent),
  },
  {
    ...
    build: () => ({ id: ulid(), type: "PromoTilesSection", density: "utilitarian", tiles: [
  ...
  },
  {
    ...
    build: () => ({ id: ulid(), type: "PoliciesAccordion",
  ...
  },
  {
    ...
    build: () => ({ id: ulid(), type: "EmailReferralSection",
