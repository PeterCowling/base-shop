...
### Non-goals
- No implementation or refactor in this lp-fact-find.
...
- None required; repository evidence was sufficient for this first-pass architectural lp-fact-find.
...
- **Delivery-Readiness:** 84%
  - Deliverable is clear (code-change), execution path clear (`/lp-build`), validation gate known.
...
- Recommended next step:
  - Proceed to `/lp-plan` using this brief and lock canonical CMS ownership in task 1.
