...
| 3 | Market and competitor scan | CDI-3 | S2 market intelligence prompt (one-time; not recurring) | Partial | `docs/business-os/startup-loop/specifications/loop-spec.yaml#S2`, `docs/business-os/market-research/_templates/deep-research-market-intelligence-prompt.md` | Low | Add CDI-3 to `process-registry-v1.md` as recurring process; distinguish from one-time S2 initial scan |
...
| 5 | Offer and value proposition iteration | OFF-1 | lp-offer (S2B) — one-time stage; CAP-01/03 partial in capability contract | Partial | `docs/business-os/startup-loop/specifications/loop-spec.yaml#S2B`, `docs/business-os/startup-loop/contracts/marketing-sales-capability-contract.md#CAP-01` | Medium | Add OFF-1 to `process-registry-v1.md` as recurring process; reference existing offer artifact path `strategy/<BIZ>/offer.user.md`; must NOT duplicate CAP-01/03 ownership |
| 6 | Pricing and revenue management review | OFF-2 | weekly-kpcs-decision-prompt.md has pricing decisions; lp-forecast (S3) for financial forecasts | Partial | `docs/business-os/workflow-prompts/_templates/weekly-kpcs-decision-prompt.md`, `docs/business-os/startup-loop/specifications/loop-spec.yaml#S3` | Low | Add OFF-2 to `process-registry-v1.md` with structured pricing review process; note revenue management for hospitality branch |
| 7 | Product/listing content and merchandising refresh | OFF-3 | lp-site-upgrade (S6) for site improvements — not recurring | Partial | `docs/business-os/startup-loop/specifications/loop-spec.yaml#S6` | Low | Add OFF-3 to `process-registry-v1.md` as recurring process separate from one-time S6 site upgrade |
| 8 | Channel policy and conflict management | OFF-4 | CAP-04 Partial in capability contract; lp-channels (S6B) for initial channel strategy | Partial | `docs/business-os/startup-loop/contracts/marketing-sales-capability-contract.md#CAP-04` | Medium | Add OFF-4 to `process-registry-v1.md` as recurring process; link to CAP-04 completion work; must not conflict with lp-channels artifact path |
...
| 11 | Sales/account pipeline and booking deals | GTM-3 | CAP-05 Missing in capability contract; no canonical gate or template | Missing | `docs/business-os/startup-loop/contracts/marketing-sales-capability-contract.md#CAP-05` | None | Add GTM-3 schema to `docs/business-os/startup-loop/schemas/sales-ops-schema.md` (TASK-03); GTM-3 = primary CAP-05 process vehicle |
| 12 | Conversion and lifecycle automation | GTM-4 | CAP-06 Missing; no lifecycle automation process or artifact | Missing | `docs/business-os/startup-loop/contracts/marketing-sales-capability-contract.md#CAP-06` | None | Add GTM-4 to `docs/business-os/startup-loop/schemas/retention-schema.md` (TASK-04); GTM-4 = automation arm of CAP-06 |
| 13 | Capacity and inventory planning | OPS-1 | bottleneck-diagnosis-schema.md covers constraint scoring; no recurring capacity planning process | Partial | `docs/business-os/startup-loop/schemas/bottleneck-diagnosis-schema.md` | Low | Add OPS-1 to `process-registry-v1.md`; profile-conditional (inventory-present / hospitality branches) |
...
| 16 | Quality assurance and maintenance management | OPS-4 | S9B (lp-launch-qa/lp-design-qa) — pre-launch QA only; no ongoing maintenance process | Partial | `docs/business-os/startup-loop/specifications/loop-spec.yaml#S9B` | Low | Add OPS-4 to `process-registry-v1.md` as recurring process; distinguish from one-time S9B pre-launch gate |
...
| 19 | Retention and loyalty loops | CX-3 | CAP-06 Missing; no retention contract | Missing | `docs/business-os/startup-loop/contracts/marketing-sales-capability-contract.md#CAP-06` | None | Add CX-3 to `docs/business-os/startup-loop/schemas/retention-schema.md` (TASK-04); CX-3 = retention-journey arm of CAP-06; complements GTM-4 |
...
|---|---|---|
| CDI-2 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| GTM-2 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| GTM-3 | `docs/business-os/startup-loop/schemas/sales-ops-schema.md` | TASK-03 |
| GTM-4 | `docs/business-os/startup-loop/schemas/retention-schema.md` | TASK-04 |
| OPS-2 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` (with post-launch scope note) | TASK-02 |
| OPS-3 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` (conditional) | TASK-02 |
| CX-1 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| CX-2 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| CX-3 | `docs/business-os/startup-loop/schemas/retention-schema.md` | TASK-04 |
| CX-4 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| FIN-2 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
| FIN-4 | `docs/business-os/startup-loop/_deprecated/process-registry-v1.md` | TASK-02 |
