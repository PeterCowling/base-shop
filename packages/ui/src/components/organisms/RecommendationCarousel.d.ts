 ...
 */
export declare function RecommendationCarousel({ endpoint, itemsPerSlide, gapClassName, getSlideWidth, className, ...props }: RecommendationCarouselProps): import("react/jsx-runtime").JSX.Element;
