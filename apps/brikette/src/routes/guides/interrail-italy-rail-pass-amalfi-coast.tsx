...
export const GUIDE_KEY: GuideKey = "interrailAmalfi";
export const GUIDE_SLUG = "interrail-italy-rail-pass-amalfi-coast" as const;

const manifestEntry = getGuideManifestEntry(GUIDE_KEY);
if (!manifestEntry) {
  throw new Error("guide manifest entry missing for interrailAmalfi"); // i18n-exempt -- TECH-000 [ttl=2026-12-31]
}
