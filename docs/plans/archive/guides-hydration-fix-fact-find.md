...
This lp-do-fact-find documents verified causes, contributing factors, testing gaps, and safe improvement opportunities.
...
- **Blocking items:** None
- **Recommended next step:** Proceed to `/lp-do-plan` with the following priorities:
