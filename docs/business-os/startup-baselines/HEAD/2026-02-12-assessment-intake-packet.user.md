...
Source-ASSESSMENT-01: docs/business-os/strategy/HEAD/2026-02-20-problem-statement.user.md
Source-ASSESSMENT-02: docs/business-os/strategy/HEAD/2026-02-20-solution-profile-results.user.md
Source-ASSESSMENT-03: docs/business-os/strategy/HEAD/2026-02-20-solution-decision.user.md
...
Source-ASSESSMENT-08: docs/business-os/strategy/HEAD/2026-02-20-operator-context.user.md
...
**Frequency:** daily (morning setup) + multiple handovers per week for the caregiver segment; several times per week for the active wearer segment.
**Severity:** high in caregiver segment — the spare coil is the most commonly lost item; a dropped processor is a high-cost replacement event. Confirmed at population level by BCIG formal lost-processor guidance.
...
|---|---|
| Manufacturer accessories (Cochlear, MED-EL, AB) | Brand-locked compatibility; clinical design language; no cross-brand system |
| Third-party retention products (Etsy/DTC, EUR18–38) | No range coherence; no Italian-language support; no cross-brand compatibility guarantee |
| DIY (tape, hair ties, elastic bands) | Not durable; socially awkward for school-age children; not a repeatable system |
| Behavioural compensation (restriction, extra checking) | High cognitive load; limits child activity participation; no structural fix |
| Organisation: no systematic workaround exists | Ad-hoc kit across manufacturer cases, school bags, and verbal handover instructions |
...
|---|---|---|---|
| Exact in-stock date | Required for launch timing and spend planning | Pete | critical |
| Sellable units (launch quantity) | Required for CAC guardrails and stockout risk modelling | Pete | critical |
| Processor compatibility matrix | Required to reduce wrong-buy and return risk; must cover Cochlear / MED-EL / AB main processor families | Pete | critical |
| Final pricing model (single vs bundle) | Required for contribution margin and CAC guardrails | Pete | high |
| Indicative price range | Required for forecasting and positioning | Pete | high |
...
[
  {
    ...
    "evidence": ["docs/business-os/market-research/HEAD/2026-02-20-market-intelligence.user.md", "Competitor patterns"]
  },
  {
