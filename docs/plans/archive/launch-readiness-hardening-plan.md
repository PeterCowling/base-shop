...
- Launch pipeline plan (P0.1): `docs/plans/archive/launch-shop-pipeline-plan.md` ✅ **COMPLETE (2026-01-20)**
- Secrets plan (P0.2): `docs/plans/integrated-secrets-workflow-plan.md`
- Health checks plan (P0.3): `docs/plans/archive/post-deploy-health-checks-mandatory-plan.md` ✅ **COMPLETE (2026-01-20)**
...
- Build the full `pnpm launch-shop` orchestrator (tracked in `docs/plans/archive/launch-shop-pipeline-plan.md` — **now complete**).
...
- Touchpoints:
  ...
  - `docs/plans/archive/post-deploy-health-checks-mandatory-plan.md` (DEPLOY-04 alignment)
- Tests/verification:
