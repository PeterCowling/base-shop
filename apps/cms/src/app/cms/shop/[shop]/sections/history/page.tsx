  ...
  return (
    <Section contentWidth="normal">
      <div className="p-6">
        ...
        {items.length === 0 && (
          <p className="text-sm text-muted-foreground">{t("cms.sections.history.empty")}</p>
        )}
              ...
              <div className="flex items-center justify-between">
                ...
                {e.after && (
                  ...
                  >
                    ...
                    <button type="submit" className="inline-flex min-h-11 min-w-11 items-center justify-center rounded border bg-surface px-3 text-sm hover:bg-surface-2">{t("cms.sections.history.restore")}</button>
                  </form>
                )}
              </div>
            </li>
