...
describe("useThemePresets", function () {
    ...
    it("saves preset and updates state", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    result = (0, react_1.renderHook)(function () {
                        return (0, useThemePresets_1.useThemePresets)(__assign(__assign({}, baseArgs), { theme: "base", overrides: { color: "#000" }, setTheme: jest.fn(), setOverrides: jest.fn(), setThemeDefaults: jest.fn() }));
                    }).result;
                    (0, react_1.act)(function () { return result.current.setPresetName("custom"); });
                    return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, result.current.handleSavePreset()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    it("deletes preset and updates state", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    result = (0, react_1.renderHook)(function () {
                        return (0, useThemePresets_1.useThemePresets)({
                            shop: "shop1",
                    ...
                    return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, result.current.handleDeletePreset()];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
