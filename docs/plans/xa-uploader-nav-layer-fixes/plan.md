...
- [ ] TASK-01: Add show-all browse mode to EditProductFilterSelector (+ i18n keys for both tasks)
...
|---|---|---|---:|---:|---|---|---|
| TASK-01 | IMPLEMENT | Add show-all browse mode + all new i18n keys | 90% | M | Pending | - | TASK-02, TASK-03 |
| TASK-02 | IMPLEMENT | Replace onHeaderExtra portal with inline nav | 90% | M | Pending | TASK-01 | TASK-03 |
| TASK-03 | IMPLEMENT | Typecheck and lint gate | 95% | S | Pending | TASK-01, TASK-02 | - |
