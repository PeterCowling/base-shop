...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed, sessionId, cfg, svc, tracking, _a, trackingNumber, labelUrl;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    tracking = null;
                    if (!(cfg.labelService === "ups" &&
                        svc.upsEnabled &&
                        cfg.returnCarrier.includes("ups"))) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, shipping_1.createUpsReturnLabel)(sessionId)];
                case 3:
                    _a = _d.sent(), trackingNumber = _a.trackingNumber, labelUrl = _a.labelUrl;
                    return [4 /*yield*/, (0, orders_1.setReturnTracking)(shop_json_1.default.id, sessionId, trackingNumber, labelUrl)];
                case 4:
                    _d.sent();
                    tracking = { number: trackingNumber, labelUrl: labelUrl };
                    _d.label = 5;
                case 5: return [2 /*return*/, server_1.NextResponse.json({
                        ok: true,
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!(cfg.labelService === "ups" &&
                        svc.upsEnabled &&
                        cfg.returnCarrier.includes("ups"))) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, shipping_1.getUpsStatus)(tracking)];
                case 2:
                    status_1 = _b.sent();
                    if (!status_1) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, orders_1.setReturnStatus)(shop_json_1.default.id, tracking, status_1)];
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4: return [2 /*return*/, server_1.NextResponse.json({ ok: true, status: status_1 })];
                case 5: return [2 /*return*/, server_1.NextResponse.json({ ok: false, error: "unsupported provider" }, { status: 400 })];
            }
        });
    });
}
