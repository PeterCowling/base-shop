...
const rgbColor = (r, g, b) => new THREE.Color(r / 255, g / 255, b / 255);
const DEFAULT_COLORS = {
  body: rgbColor(199, 180, 155),
  handle: rgbColor(59, 42, 33),
  hardware: rgbColor(210, 212, 216),
  lining: rgbColor(200, 162, 122),
  personalization: rgbColor(139, 111, 85),
};
const DEFAULT_MATERIAL_COLOR = rgbColor(255, 255, 255);

function createMaterial(
  name,
  { color = DEFAULT_MATERIAL_COLOR, metalness = 0, roughness = 0.8 } = {},
) {
...
async function exportGlb(scene, outputPath) {
  // eslint-disable-next-line security/detect-non-literal-fs-filename -- HBAG-0001 output paths are derived from repo constants
