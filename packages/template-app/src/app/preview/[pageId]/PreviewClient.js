...
var DynamicRenderer_1 = require("@/components/DynamicRenderer");
var DeviceSelector_1 = require("@ui/src/components/DeviceSelector");
var devicePresets_1 = require("@ui/utils/devicePresets");
var usePreviewDevice_1 = require("@ui/src/hooks/usePreviewDevice");
function PreviewClient(_a) {
    var components = _a.components, locale = _a.locale, initialDeviceId = _a.initialDeviceId;
    var _b = (0, usePreviewDevice_1.usePreviewDevice)(initialDeviceId), deviceId = _b[0], setDeviceId = _b[1];
