/* -------------------------------------------------------------------------
   ...
   Privacy Policy (EN-first; other locales fall back to EN until translated)
   ---------------------------------------------------------------------- */
...
export default memo(function PrivacyPolicyPage() {
  ...
  const fallbackHeadDescriptors = (() => {
    ...
    const path = `/${lang}/${getSlug("privacyPolicy", lang)}`;
