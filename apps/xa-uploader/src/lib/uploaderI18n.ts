...
const messages = {
  en: {
    ...
    instructionsSection2Step4: "Use Save as draft in Step 1 (Product) to persist your latest edits.",
    instructionsSection2ScreenshotCaption:
      "Current Add screen with Product step fields and the Save as draft action in the form area.",
  ...
  zh: {
    ...
    instructionsSection2Step4: "在步骤 1（产品）中使用“保存为草稿”及时保存当前修改。",
    instructionsSection2ScreenshotCaption: "当前“添加”页面：产品步骤字段和表单区域中的“保存为草稿”操作。",
