...
# XA-B deployment (Cloudflare Pages, stealth mode)

XA is a Next.js app intended for Cloudflare Pages using `@cloudflare/next-on-pages`.

## Build and local preview
```
pnpm --filter @apps/xa-b exec next-on-pages
pnpm --filter @apps/xa-b exec wrangler pages dev .vercel/output/static --compatibility-flag=nodejs_compat --port 3013
```
...
- Service worker: `apps/xa-b/public/sw.js`
- Offline fallback page: `apps/xa-b/public/offline.html`
