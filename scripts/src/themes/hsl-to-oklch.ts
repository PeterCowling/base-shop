...
const shadeTokens: Record<string, { light: string; dark: string }> = {
  ...
  '--color-warmGreenShades-row1': { light: 'hsl(110 46% 58%)', dark: 'hsl(110 22% 22%)' },
  '--color-warmGreenShades-row2': { light: 'hsl(110 44% 50%)', dark: 'hsl(110 20% 27%)' },
  '--color-warmGreenShades-row3': { light: 'hsl(110 41% 42%)', dark: 'hsl(110 18% 32%)' },
  '--color-warmGreenShades-row4': { light: 'hsl(110 38% 34%)', dark: 'hsl(110 16% 37%)' },
  '--color-warmGreenShades-row5': { light: 'hsl(110 35% 27%)', dark: 'hsl(110 14% 42%)' },
