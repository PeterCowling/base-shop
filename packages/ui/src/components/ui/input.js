...
export const Input = React.forwardRef(({ className, label, error, floatingLabel, wrapperClassName, id, onFocus, onBlur, ...props }, ref) => {
     ...
     *  Render
     * ------------------------------------------------------------------ */
    return (_jsxs("div", { className: cn("relative", wrapperClassName), children: [floatingLabel ? (_jsxs(_Fragment, { children: [_jsx("input", { id: inputId, ref: ref, className: baseClasses, "aria-invalid": error ? true : undefined, onFocus: handleFocus, onBlur: handleBlur, ...props }), label && (_jsx("label", { htmlFor: inputId, className: cn("text-muted-foreground pointer-events-none absolute top-2 left-3 transition-all", (focused || hasValue) && "-translate-y-3 text-xs"), children: label }))] })) : (_jsxs(_Fragment, { children: [label && (_jsx("label", { htmlFor: inputId, className: "mb-1 block text-sm font-medium", children: label })), _jsx("input", { id: inputId, ref: ref, className: baseClasses, "aria-invalid": error ? true : undefined, onFocus: handleFocus, onBlur: handleBlur, ...props })] })), error && _jsx("p", { className: "mt-1 text-sm text-red-600", children: error })] }));
});
