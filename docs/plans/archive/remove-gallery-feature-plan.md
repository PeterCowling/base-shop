...
- Related brief: `docs/plans/remove-gallery-feature-lp-do-fact-find.md`
- Key findings:
...
- **Confidence:** 90%
  ...
  - Approach: 90% — Straightforward data transformation, credits append to caption per lp-do-fact-find pattern
...
- **Planning validation:**
  - Tests run: Listed 29 EN guides with gallery JSON (lp-do-fact-find)
...
- **Notes / references:**
  - Validation checklist based on lp-do-fact-find acceptance criteria
