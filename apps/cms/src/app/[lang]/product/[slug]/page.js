...
function generateStaticParams() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            langs = i18n_1.LOCALES;
            slugs = ["green-sneaker", "sand-sneaker", "black-sneaker"];
            return [2 /*return*/, langs.flatMap(function (lang) { return slugs.map(function (slug) { return ({ lang: lang, slug: slug }); }); })];
        });
    });
}
    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    slug = (_c.sent()).slug;
                    product = (0, products_1.getProductBySlug)(slug);
                    return [2 /*return*/, {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, <PdpClient_client_1.default product={product}/>];
            }
        });
    });
}
