...
var PagesClient_1 = require("./PagesClient");
exports.revalidate = 0;
function PagesPage(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var shop, _c, session, initial, writable;
            ...
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, index_server_1.getPages)(shop),
                        ])];
                case 3:
                    _c = _d.sent(), session = _c[0], initial = _c[1];
                    writable = (0, _auth_1.canWrite)(session === null || session === void 0 ? void 0 : session.user.role);
                    return [2 /*return*/, (<div>
      <h2 className="mb-4 text-xl font-semibold">Pages – {shop}</h2>
      <react_1.Suspense fallback={<p>Loading pages…</p>}>
        <PagesClient_1.default shop={shop} initial={initial} canWrite={writable}/>
      </react_1.Suspense>
    </div>)];
            }
        });
