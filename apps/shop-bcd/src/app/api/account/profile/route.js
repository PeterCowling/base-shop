        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, customerProfiles_1.getCustomerProfile)(session.customerId)];
                case 2:
                    profile = _a.sent();
                    if (!profile) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Profile not found" }, { status: 404 })];
                    }
