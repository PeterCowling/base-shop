...
import HOW_TO_GET_HERE_SCHEMA_EN from "../../src/locales/en/howToGetHereSchema.json";
...
export const linkTargetSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("guide"), guideKey: z.string().min(1) }),
...
export type HowToGetHereRoutesLocale = z.infer<typeof routeContentSchema>;
