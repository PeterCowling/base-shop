...
var permissions_1 = require("@auth/types/permissions");
...
function PermissionsPage() {
    return __awaiter(this, void 0, void 0, function () {
        function save(formData) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, rbac_server_1.updateRolePermissions)(formData)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        var session, db, roles, permissions;
        return __generator(this, function (_a) {
            switch (_a.label) {
      ...
      {roles.map(function (role) { return (<form key={role} action={save} className="mb-4 rounded border p-3">
          <input type="hidden" name="role" value={role}/>
          <p className="font-semibold">{role}</p>
          <div className="my-2 flex flex-wrap gap-2">
            {permissions.map(function (perm) {
                                    var _a;
                                    return (<label key={perm} className="flex items-center gap-1 text-sm">
                <input type="checkbox" name="permissions" value={perm} defaultChecked={(_a = db.permissions[role]) === null || _a === void 0 ? void 0 : _a.includes(perm)}/>
                {perm}
              </label>);
                                })}
          </div>
