...
/**
 * Dark theme design profile — dark-mode CMS variant.
 * Uses layered elevation surfaces (surface-1 through surface-3)
 * instead of shadows for depth hierarchy on dark backgrounds.
 */
export const profile: DesignProfile = {
  ...
  // Category B — flat elevation, defined borders (dark surfaces need edge definition)
  surface: {
    defaultRadius: "md",
