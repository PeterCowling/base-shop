...
export async function checkAndAlert(shop, items) {
    const settings = await getShopSettings(shop);
    const envRecipients = coreEnv.STOCK_ALERT_RECIPIENTS ?? coreEnv.STOCK_ALERT_RECIPIENT;
    ...
    const defaultThreshold = settings.stockAlert?.threshold ?? coreEnv.STOCK_ALERT_DEFAULT_THRESHOLD;
