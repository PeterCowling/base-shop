...
- [x] TASK-01: Create filterCatalogProducts utility + unit tests
- [x] TASK-02: Create EditProductFilterSelector component + wire into ReviseScreen
...
|---|---|---|---:|---:|---|---|---|
| TASK-01 | IMPLEMENT | filterCatalogProducts utility + tests | 85% | S | Complete | - | TASK-02 |
| TASK-02 | IMPLEMENT | EditProductFilterSelector + ReviseScreen wiring | 85% | M | Complete | TASK-01 | - |
